...
class Kernel extends ConsoleKernel {
    ...
    protected function schedule(Schedule $schedule) {
        ...
        $schedule->call(new \App\Cronjobs\Landlord\EmailCron)->everyMinute();
        ...
        $schedule->call(new \App\Cronjobs\Landlord\SyncPackagesCron)->everyFiveMinutes(); //[not less then 5 mins]
        $schedule->call(new \App\Cronjobs\Landlord\Scheduled\DeleteDatabasesCron)->everyFiveMinutes(); //[not less then 5 mins]
        $schedule->call(new \App\Cronjobs\Landlord\Scheduled\UpdateEmailDomain)->everyMinute();
        $schedule->call(new \App\Cronjobs\Landlord\TenantsCronStatus)->everyMinute();
        $schedule->call(new \App\Cronjobs\Landlord\CustomerStatusCron)->hourly();
        $schedule->call(new \App\Cronjobs\Landlord\Scheduled\DeleteDatabasesCron)->everyMinute();
