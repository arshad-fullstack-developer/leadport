@extends('landlord.layout.wrapper') 
@section('content')
<!-- main content -->
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-12">
            ...
            <a href="{{ url('app-admin/auth/logout') }}" class="btn btn-success float-right" target="_blank">Logout</a>           
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ url('app-admin/events/create') }}" method="POST" id="eventForm">
                                @csrf
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        eventClick: function(info) {
            ...
            document.getElementById('eventForm').action = `{{ url('app-admin/events/update') }}`;
            // Show the modal
