<head>
    ...
    <link rel="stylesheet" href="{{ asset('public/js/codemirror/codemirror.min.css?v=') }} {{ config('system.versioning') }}">
    <link rel="stylesheet" href="{{ asset('public/js/codemirror/darcula.min.css?v=') }} {{ config('system.versioning') }}">
