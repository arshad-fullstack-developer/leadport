...
<script type="text/javascript" src="{{ asset('public/js/codemirror/codemirror.min.js?v=') }} {{ config('system.versioning') }}"></script>
<script type="text/javascript" src="{{ asset('public/js/codemirror/css.min.js?v=') }} {{ config('system.versioning') }}"></script>
