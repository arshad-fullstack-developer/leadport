          ...
          <div class="btn-group" role="group" aria-label="Basic example">
             @if(isset($transportChannels)) 
              @foreach($transportChannels as $tchannel)
                <button type="button" disabled class="btn btn-outline-success {{ ($tchannel['id'] ==  $ticket['ticket_transport_channel_id']) ? 'active' : '' }}" onclick="selectChannel({{ $tchannel['id'] }})"><i class="ti-sea"></i>{{ $tchannel['name'] }}</button>
              @endforeach
            @endif
                    ...
                    <div class="row mt-3" >
                        ...
                        <div class="col">
                            ...
                            <select id="inputState" class="form-control" disabled name="ticket_type_id">
                              ...
                              <option value="{{ $carriage['id'] }}" {{ runtimePreselected($type['id'] ?? '', $ticket['ticket_type_id']) }}>{{ $carriage['name'] }}</option>
                              @endforeach
                            </select>
                            @endif
                          </div>
              ...
              <div class=" col-sm-12 col-lg-6">
                  ...
                  <div class="row mt-3" >
                    ...
                    <div class="col">
                      ...
                      <input type="date" class="form-control" readonly id="shipper_date" name="shipping_date" placeholder="Date" aria-label="date" value="{{ $ticket['shipping_date'] }}">
                  </div>
                  <div class="col">
                            ...
                            <div id="pickupRemarks">
                                <!-- Existing delivery field -->
                                 @if(isset($ticket['pickupRemarks']) && count($ticket['pickupRemarks']) > 0)
                                    ...
                                    <input type="text" class="form-control pickup" readonly name="pickupRemarks[{{ $key }}]" placeholder="pickupRemarks" value="{{ $remark }}" aria-label="Pickup Remark">
                                </div>
                                    @endforeach
                                    @else
...
<!-- form row three -->
                ...
                <div class="col-sm-12 col-lg-6">
                  ...
                  <div class="row mt-3" >
                    <div class="col">
                      ...
                      <input type="date" class="form-control" readonly id="consignee_date" name="delivery_date" value="{{ $ticket['delivery_date'] }}" placeholder="Date" aria-label="date">
                  </div>
                  <div class="col">
                    <label for="id" class="form-label fw-bold">Time</label>
                          ...
                          <div id="delivery-container" class="col-12 mt-3 delivery">
                            ...
                            <div id="deliveryRemarks">
                                ...
                                @if(isset($ticket['deliveryRemarks']) && count($ticket['deliveryRemarks']) > 0)
                                    ...
                                    <input type="text" class="form-control delivery" readonly name="deliveryRemarks[{{ $key }}]" placeholder="deliveryRemarks" value="{{ $remark }}" aria-label="Delivery Remark">
                                </div>
                                    @endforeach
                                    @else
      ...
      <!-- form row four -->
          ...
          <div class="row mt-2"> <!-- Optional mt-2 for margin -->
              <input type="number" class="form-control" readonly name="chargeable_weight_total" placeholder="Chargeable Weight Total" value="{{ $ticket['chargeable_weight_total'] }}" aria-label="notes" id="ChargeableWeightTotal">
          </div>
                          <div class="text-lg-right"> 
                                   <a href="{{ url('/ctickets/'.$ticket['id'].'/edit') }}" class="btn btn-rounded-x btn-success m-t-20">
                                      Edit
                                  </a>
                          </div>
