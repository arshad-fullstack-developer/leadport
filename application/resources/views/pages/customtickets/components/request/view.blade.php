  ...
  <div class="row mt-3">
   ...
   <div class="row mt-3 bg-white p-3">
        ...
        <div class="row mt-3 bg-white p-3">
            ...
            &nbsp;&nbsp;
            <input type="number" class="form-control" readonly name="ChargeableWeightTotal" placeholder="Chargeable Weight Total" aria-label="notes" id="ChargeableWeightTotal" value="{{ $ticket['ChargeableWeightTotal'] }}" >
        </div>
</form>
