...
<span id="transport"><i class='fas fa-train'></i>Rail</span></button>
  ...
  <div class="x-section updated">
             <div class="x-element"><i class="ti-archive"></i>
                <span>L Type: </span>
                <span class="x-highlight">{{ $task->task_custom_field_3 }}</span>
            </div>

            <div class="x-element"><i class="mdi mdi-truck"></i>
                <span>Equip: </span>
                <span class="x-highlight">{{ $task->task_custom_field_2 }}</span>
            </div>

            <div class="x-element"><i class="sl-icon-layers"></i>
                <span>Quantity: </span>
                <span class="x-highlight">{{ $task->task_custom_field_4 }}</span>
            </div>
      </div>
</div>
...
<div class="row mt-3">
  <div class="col-sm-12">
  <p class="text-center">Transit Time : <strong>{{ $task->task_custom_field_23 }}</strong></p>
      <div class="bar">
            <?php $elSet = 5; ?>
            <?php for ($n = 0; $n < $elSet; $n++) : ?>
                <input class="bar-input" type="radio" name="input" id="input_<?php echo $n; ?>">
                <div class="bar-view">
                    <label class="bar-button" for="input_<?php echo $n; ?>"></label>
                </div>
            <?php endfor; ?>
        </div>

    <p class="text-center mt-3">Incoterms location : <strong>{{ $task->task_custom_field_15 }}</strong></p>    
  </div>
</div>
  ...
  <div class="d-flex">
    ...
    <h6 class="mb-3">&nbsp;Pickup Information</h6>
    <span class="custom-text">Pickup : <strong>{{ $task->task_custom_field_5 }}</strong></span> <br /><br />
  ...
  <div class="form-row">
    ...
    <span class="custom-text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Delivery : <strong>{{ $task->task_custom_field_10 }}</strong></span>  <br /><br />
...
<div class="form-row">
  ...
  <div class="form-group col-sm-12"> 
  <span class="custom-text"><img src="{{ url('/') }}/public/images/temp.png" alt="" width="80"> &nbsp;&nbsp;<strong>{{ $task->task_custom_field_18  }}</strong>
  </span>   
  
  <span class="custom-text">&nbsp;&nbsp;<img src="{{ url('/') }}/public/images/fragile.png" alt="" width="80"> &nbsp;&nbsp;<strong>{{ $task->task_custom_field_19  }}</strong>
  </span>

  <span class="custom-text">&nbsp;&nbsp;<img src="{{ url('/') }}/public/images/adr.png" alt="" width="80">&nbsp;&nbsp;<strong>{{ $task->task_custom_field_16 }}</strong>
    </span>   
