    ...
    <form class="form-inline row gy-2 gx-3 align-items-center" id="reports-list-page-filter-form">
        ...
        <div class="col-auto">
            ...
            <button type="submit" id="submitButton" class="btn btn-info btn-sm waves-effect text-left ajax-request"
                data-url="<?php echo e(url('report/timesheets/project?action=load')); ?>"
...
</div><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/reports/timesheets/project/filter.blade.php ENDPATH**/ ?>