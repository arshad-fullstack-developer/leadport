    ...
    <table class="table" id="table">
        ...
        <?php $__currentLoopData = $ticket['goods']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $good): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
            ...
            <tr id="<?php echo e($key); ?>">
                <td><input type="number" class="form-control" readonly  id="<?php echo e($key); ?>"   name="goods[<?php echo e($key); ?>][qty]"          value="<?php echo e($good['qty']); ?>"></td>
                <td><input type="number" class="form-control" readonly  id="<?php echo e($key); ?>"   name="goods[<?php echo e($key); ?>][unitid]"       value="<?php echo e($good['unitid']); ?>"></td>
                ...
                <td><input type="number" class="form-control" readonly  id="<?php echo e($key); ?>"   name="goods[<?php echo e($key); ?>][kgcalc]"       value="<?php echo e($good['kgcalc']); ?>"></td>
                ...
                <td><input type="number" class="form-control" readonly id="<?php echo e($key); ?>"   name="goods[<?php echo e($key); ?>][volumem3]"     value="<?php echo e($good['volumem3']); ?>"></td>
                <td><input type="number" class="form-control" readonly  id="<?php echo e($key); ?>"   name="goods[<?php echo e($key); ?>][lengthcm]"     value="<?php echo e($good['lengthcm']); ?>"></td>
                <td><input type="number" class="form-control" readonly id="<?php echo e($key); ?>"   name="goods[<?php echo e($key); ?>][widthcm]"      value="<?php echo e($good['widthcm']); ?>"></td>
                <td><input type="number" class="form-control" readonly id="<?php echo e($key); ?>"   name="goods[<?php echo e($key); ?>][heightcm]"     value="<?php echo e($good['heightcm']); ?>"></td>
            </tr>
