...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-12">
            ...
            <a href="<?php echo e(url('app-admin/auth/logout')); ?>" class="btn btn-success float-right" target="_blank">Logout</a>           
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="<?php echo e(url('app-admin/events/create')); ?>" method="POST" id="eventForm">
                                <?php echo csrf_field(); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        eventClick: function(info) {
            ...
            document.getElementById('eventForm').action = `<?php echo e(url('app-admin/events/update')); ?>`;
            // Show the modal
    ...
    if (confirm('Are you sure you want to delete this event?')) {
        fetch(`${appUrl}/app-admin/events/${eventId}/delete`, {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('landlord.layout.wrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/landlord/calendar/calendar.blade.php ENDPATH**/ ?>