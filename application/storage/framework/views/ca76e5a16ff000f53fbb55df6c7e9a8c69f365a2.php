...
<aside class="left-sidebar" id="js-trigger-nav-team">
        ...
        <nav class="sidebar-nav" id="main-sidenav">
            <ul id="sidebarnav">
                ...
                <li class="sidenav-menu-item <?php echo e($page['mainmenu_home'] ?? ''); ?> menu-tooltip menu-with-tooltip"
                    ...
                    <a class="waves-effect waves-dark" href="<?php echo e(url('app-admin/home')); ?>" aria-expanded="false" target="_self">
                        <i class="ti-home"></i>
                ...
                <li class="sidenav-menu-item <?php echo e($page['mainmenu_customers'] ?? ''); ?> menu-tooltip menu-with-tooltip"
                    ...
                    <a class="waves-effect waves-dark" href="<?php echo e(url('app-admin/customers')); ?>" aria-expanded="false" target="_self">
                ...
                <li class="sidenav-menu-item <?php echo e($page['mainmenu_packages'] ?? ''); ?> menu-tooltip menu-with-tooltip"
                    ...
                    <a class="waves-effect waves-dark" href="<?php echo e(url('app-admin/packages')); ?>" aria-expanded="false" target="_self">
                ...
                <li class="sidenav-menu-item <?php echo e($page['mainmenu_subscriptions'] ?? ''); ?> menu-tooltip menu-with-tooltip"
                    ...
                    <a class="waves-effect waves-dark" href="<?php echo e(url('app-admin/subscriptions')); ?>" aria-expanded="false"
                        target="_self">
                        <i class="ti-reload"></i>
                ...
                <li data-modular-id="main_menu_team_clients"
                    ...
                    <ul aria-expanded="false" class="collapse">
                        <li class="sidenav-submenu <?php echo e($page['submenu_online'] ?? ''); ?>" id="submenu_online">
                            <a href="<?php echo e(url('app-admin/payments')); ?>"
                        ...
                        <li class="sidenav-submenu <?php echo e($page['submenu_offline'] ?? ''); ?>" id="submenu_offline">
                            <a href="<?php echo e(url('app-admin/offline-payments')); ?>"
                ...
                <li class="sidenav-menu-item hidden <?php echo e($page['mainmenu_blogs'] ?? ''); ?> menu-tooltip menu-with-tooltip"
                    ...
                    <a class="waves-effect waves-dark" href="<?php echo e(url('app-admin/blogs')); ?>" aria-expanded="false" target="_self">
                ...
                <li class="sidenav-menu-item <?php echo e($page['mainmenu_events'] ?? ''); ?> menu-tooltip menu-with-tooltip"
                    ...
                    <a class="waves-effect waves-dark" href="<?php echo e(url('app-admin/events')); ?>" aria-expanded="false" target="_self">
                        <i class="ti-time"></i>
                ...
                <li class="sidenav-menu-item <?php echo e($page['mainmenu_team'] ?? ''); ?> menu-tooltip menu-with-tooltip"
                    ...
                    <a class="waves-effect waves-dark" href="<?php echo e(url('app-admin/team')); ?>" aria-expanded="false" target="_self">
                ...
                <li class="sidenav-menu-item <?php echo e($page['mainmenu_frontend'] ?? ''); ?> menu-tooltip menu-with-tooltip"
                    ...
                    <a class="waves-effect waves-dark" href="<?php echo e(url('app-admin/frontend/start')); ?>" aria-expanded="false"
                        target="_self">
                ...
                <li class="sidenav-menu-item <?php echo e($page['mainmenu_settings'] ?? ''); ?> menu-tooltip menu-with-tooltip"
                    ...
                    <a class="waves-effect waves-dark" href="<?php echo e(url('app-admin/settings/general')); ?>" aria-expanded="false"
                        target="_self">
    ...
    <!-- End Sidebar scroll-->
</aside><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/landlord/layout/leftmenu.blade.php ENDPATH**/ ?>