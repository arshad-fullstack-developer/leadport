    ...
    <div class="x-message-field hidden" id="card-comment-tinmyce-container">
        ...
        <div class="x-button p-t-10 p-b-10 text-right">
            ...
            <button type="button" class="btn btn-success btn-sm x-submit-button" id="card-comment-post-button"
                data-url="<?php echo e(url('/leads/'.$lead->lead_id.'/post-comment')); ?>" data-type="form" data-ajax-type="post"
...
<!--/#complete commenting form-->
<?php endif; ?><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/lead/components/post-comment.blade.php ENDPATH**/ ?>