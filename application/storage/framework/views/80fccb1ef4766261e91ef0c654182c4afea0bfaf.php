        ...
        <div class="slimscrollright">
            ...
            <div class="rpanel-title">
                ...
                <div class="display-inline-block">
                    <?php echo app('translator')->get('lang.product_tasks'); ?> (<?php echo app('translator')->get('lang.automation'); ?>) <span class="align-middle display-inline p-t-3 p-l-8"
                        data-toggle="tooltip" title="<?php echo app('translator')->get('lang.product_tasks_info'); ?>" data-placement="top"><i class="ti-info-alt font-17"></i></span>
                </div>
                <span>
            ...
            <div class="r-panel-body products-tasks-side-panel-body  p-b-80">
                ...
                <div class="text-right p-b-30">
                    ...
                    <button type="button" id="create-product-task-button"
                        ...
                        data-loading-target="commonModalBody" data-modal-title="<?php echo app('translator')->get('lang.add_task'); ?>"
                        ...
                        data-action-ajax-loading-target="commonModalBody"><?php echo app('translator')->get('lang.add_task'); ?>
                    </button>
                </div>
...
<!--sidebar--><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/itemtasks/components/tasks-side-panel.blade.php ENDPATH**/ ?>