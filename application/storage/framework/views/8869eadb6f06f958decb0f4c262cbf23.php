...
<tr id="proposal_<?php echo e($proposal->doc_id); ?>">
    ...
    <td class="col_doc_id">
        ...
        <!--automation-->
        <?php if(auth()->user()->is_team && $proposal->proposal_automation_status == 'enabled'): ?>
        <span class="sl-icon-energy text-warning p-l-5" data-toggle="tooltip"
            title="<?php echo app('translator')->get('lang.proposal_automation'); ?>"></span>
        <?php endif; ?>
    </td>
    ...
    <td class="col_foo">
        ...
        <?php if($proposal->doc_publishing_type == 'scheduled' && $proposal->doc_publishing_scheduled_status == 'pending'): ?>
        <span class="label label-icons label-icons-warning" data-toggle="tooltip" data-placement="top"
            title="<?php echo app('translator')->get('lang.scheduled_publishing_info'); ?>: <?php echo e(runtimeDate($proposal->doc_publishing_scheduled_date)); ?>"><i
            ...
            <span class="list-table-action dropdown font-size-inherit">
                ...
                <div class="dropdown-menu" aria-labelledby="listTableAction">
                    ...
                    <a class="dropdown-item"
                        href="<?php echo e(url('/proposals/view/'.$proposal->doc_unique_id.'?action=preview')); ?>"
                    ...
                    <!--clone proposal-->
                    <?php if(auth()->user()->role->role_proposals > 1): ?>
                    <a class="dropdown-item actions-modal-button js-ajax-ux-request reset-target-modal-form edit-add-modal-button"
                        href="javascript:void(0)" data-toggle="modal" data-target="#commonModal"
                        data-modal-title="<?php echo e(cleanLang(__('lang.clone_proposal'))); ?>"
                        data-url="<?php echo e(url('/proposals/'.$proposal->doc_id.'/clone')); ?>"
                        data-action-url="<?php echo e(url('/proposals/'.$proposal->doc_id.'/clone')); ?>"
                        data-loading-target="actionsModalBody" data-action-method="POST">
                        <?php echo e(cleanLang(__('lang.clone_proposal'))); ?></a>
                    <?php endif; ?>
                    ...
                    <a href="javascript:void(0)"
                        ...
                        data-url="<?php echo e(urlResource('/proposals/'.$proposal->doc_id.'/edit-automation?ref=list')); ?>"
                        data-loading-target="commonModalBody" data-modal-title="<?php echo app('translator')->get('lang.proposal_automation'); ?>"
                        data-action-url="<?php echo e(urlResource('/proposals/'.$proposal->doc_id.'/edit-automation?ref=list')); ?>"
                        data-action-method="POST"
                        data-action-ajax-loading-target="commonModalBody"><?php echo app('translator')->get('lang.automation'); ?>
                    </a>
...
<!--each row--><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/proposals/components/table/ajax.blade.php ENDPATH**/ ?>