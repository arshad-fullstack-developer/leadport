...
<form class="form" id="settingsFormProjects">
    ...
    <div class="form-group row">
        <label class="col-4 control-label col-form-label"><?php echo app('translator')->get('lang.show_task_status_changes_in_event_timeline'); ?></label>
        <div class="col-3">
            <select class="select2-basic form-control form-control-sm select2-preselected"
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/settings/sections/projects/general.blade.php ENDPATH**/ ?>