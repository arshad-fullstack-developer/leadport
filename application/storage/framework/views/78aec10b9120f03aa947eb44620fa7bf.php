    ...
    <td class="tickets_col_action actions_column">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <!-- <button type="button" title="<?php echo e(cleanLang(__('lang.edit'))); ?>"
                class="data-toggle-action-tooltip btn btn-outline-success btn-circle btn-sm"
                data-url="<?php echo e(urlResource('/tickets/'.$ticket['Id'].'/edit?edit_type=all&edit_source=list')); ?>"
                data-loading-target="commonModalBody" data-modal-title="<?php echo e(cleanLang(__('lang.edit_ticket'))); ?>"
                data-action-url="<?php echo e(urlResource('/tickets/'.$ticket['Id'])); ?>" data-action-method="PUT"
