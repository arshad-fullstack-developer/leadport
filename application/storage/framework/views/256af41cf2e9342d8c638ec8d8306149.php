...
<aside class="left-sidebar settings-menu">
            ...
            <ul id="sidebarnav">
                ...
                <li class="sidenav-menu-item <?php echo e($page['settingsmenu_main'] ?? ''); ?>">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        <li>
                            <a href="javascript:void(0);" data-url="<?php echo e(url('settings/general')); ?>" id="settings-menu-main-general"
                        ...
                        <li>
                            <a href="javascript:void(0);" data-url="<?php echo e(url('settings/modules')); ?>" id="settings-menu-main-modules"
                                class="settings-menu-link js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url"><?php echo e(cleanLang(__('lang.modules'))); ?></a>
                        </li>
                        <?php endif; ?>
                        <li>
                            <a href="javascript:void(0);" data-url="<?php echo e(url('settings/company')); ?>" id="settings-menu-main-company"
                                class="settings-menu-link js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url"><?php echo e(cleanLang(__('lang.company_details'))); ?></a>
                        </li>
                        <li>
                            <a href="javascript:void(0);" data-url="<?php echo e(url('settings/currency')); ?>" id="settings-menu-main-currency"
                                class="settings-menu-link js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url"><?php echo e(cleanLang(__('lang.currency'))); ?></a>
                        </li>
                        <li>
                            <a href="javascript:void(0);" data-url="<?php echo e(url('settings/theme')); ?>" id="settings-menu-main-theme"
                                class="settings-menu-link js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url"><?php echo e(cleanLang(__('lang.theme'))); ?></a>
                        </li>
                        <li>
                            <a href="javascript:void(0);" data-url="<?php echo e(url('settings/logos')); ?>" id="settings-menu-main-logo"
                                class="settings-menu-link js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url"><?php echo e(cleanLang(__('lang.company_logo'))); ?></a>
                        </li>
                        <!--[MULTITENANCY]-->
                        <?php if(config('system.settings_type') == 'standalone'): ?>
                        <li>
                            <a href="javascript:void(0);" data-url="<?php echo e(url('settings/cronjobs')); ?>" id="settings-menu-main-cronjobs"
                                class="settings-menu-link js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url"><?php echo e(cleanLang(__('lang.cronjob_settings'))); ?></a>
                        </li>
                        <li>
                            <a href="javascript:void(0);" data-url="<?php echo e(url('settings/system/clearcache')); ?>"
                                id="settings-menu-main-cronjobs"
                                class="settings-menu-link js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url"><?php echo e(cleanLang(__('lang.clear_cache'))); ?></a>
                        </li>
                        <li>
                            <a href="javascript:void(0);" data-url="<?php echo e(url('settings/errorlogs')); ?>"
                                id="settings-menu-main-errorlogs"
                                class="settings-menu-link js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url"><?php echo e(cleanLang(__('lang.error_logs'))); ?></a>
                        </li>
                        <?php endif; ?>
                    </ul>
                </li>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="javascript:void(0);" data-url="<?php echo e(url('settings/account/myaccount')); ?>"
                                id="settings-menu-billing-account"
                                class="settings-menu-link js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url"><?php echo e(cleanLang(__('lang.my_account'))); ?></a>
                        </li>
                        <li><a href="javascript:void(0);" data-url="<?php echo e(url('settings/account/packages')); ?>"
                                id="settings-menu-billing-packages"
                                class="settings-menu-link js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url"><?php echo e(cleanLang(__('lang.packages'))); ?></a>
                        </li>
                        <li><a href="javascript:void(0);" data-url="<?php echo e(url('settings/account/payments')); ?>"
                                id="settings-menu-billing-payments"
                                class="settings-menu-link js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url"><?php echo e(cleanLang(__('lang.payments'))); ?></a>
                        </li>
                        <li><a href="javascript:void(0);" data-url="<?php echo e(url('settings/account/notices')); ?>"
                                id="settings-menu-billing-notices"
                                class="settings-menu-link js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url"><?php echo e(cleanLang(__('lang.notices'))); ?></a>
                        </li>
                    </ul>
                </li>
                <?php endif; ?>
    ...
    <!-- End Sidebar scroll-->
</aside><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/settings/leftmenu-settings.blade.php ENDPATH**/ ?>