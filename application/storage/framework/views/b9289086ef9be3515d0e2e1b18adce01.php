<div class="col-12 align-self-center hidden checkbox-actions  box-shadow-minimum" id="invoices-checkbox-actions-container">
    ...
    <div class="x-buttons">
        ...
        <button type="button" class="btn btn-sm btn-default waves-effect waves-dark confirm-action-danger"
            ...
            data-url="<?php echo e(url('/invoices/delete')); ?>" data-confirm-title="<?php echo e(cleanLang(__('lang.delete_selected_items'))); ?>"
            data-confirm-text="<?php echo e(cleanLang(__('lang.are_you_sure'))); ?>" id="checkbox-actions-delete-invoices">
        ...
        <button type="button"
            ...
            data-url="<?php echo e(urlResource('/invoices/change-category')); ?>"
            data-action-url="<?php echo e(urlResource('/invoices/change-category')); ?>" data-action-method="POST"
...
<?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/invoices/components/actions/checkbox-actions.blade.php ENDPATH**/ ?>