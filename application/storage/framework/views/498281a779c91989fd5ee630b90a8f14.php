...
<div class="card">
    <div class="card-body" id="landlord-settings-form">
        ...
        <div class="form-group row">
            <label
                class="col-12 control-label col-form-label required"><?php echo e(cleanLang(__('lang.webhooks_signing_key'))); ?>*
                <span class="align-middle text-themecontrast font-16" data-toggle="tooltip"
                    title="<?php echo e(cleanLang(__('lang.stripe_general_info'))); ?>" data-placement="top"><i
                        class="ti-info-alt"></i></span>
            </label>
        ...
        <div class="form-group row">
            ...
            <div class="col-12">
                <input type="text" class="form-control form-control-sm" id="settings_stripe_ipn_url"
                    name="settings_stripe_ipn_url" value="<?php echo e(url('/app-admin/webhooks/stripe')); ?>" disabled>
            </div>
        </div>
        ...
        <div class="hidden p-t-10" id="toogle_more_information">
            ...
            <div class="form-group form-group-checkbox row">
                ...
                <div class="col-9 p-t-5">
                    <input type="checkbox" id="settings_stripe_reset_plans" name="settings_stripe_reset_plans"
                        class="filled-in chk-col-red">
                    <label for="settings_stripe_reset_plans"></label>
                </div>
            </div>
        </div>
        ...
        <div class="text-right">
            <button type="submit" id="commonModalSubmitButton"
                ...
                data-url="<?php echo e(url('app-admin/settings/stripe')); ?>" data-form-id="landlord-settings-form"
...
<?php echo $__env->make('landlord.settings.wrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/landlord/settings/sections/gateways/stripe/page.blade.php ENDPATH**/ ?>