        ...
        <div class="card-body p-l-15 p-r-15">
            <div class="d-flex p-10 no-block">
                <span class="align-slef-center">
                    ...
                    <h6 class="text-muted m-b-0"><?php echo e(cleanLang(__('lang.projects'))); ?> - <?php echo e(cleanLang(__('lang.pending'))); ?></h6>
                </span>
...
</div><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/home/team/widgets/first-row/projects-pending.blade.php ENDPATH**/ ?>