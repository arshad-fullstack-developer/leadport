            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-lg-9">
                    <select class="select2-basic form-control form-control-sm  select2-new-options" id="lead_source"
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php if(isset($page['section']) && $page['section'] == 'edit'): ?>
                        <?php echo runtimeLeadSourceCustom($sourcelist, $lead->lead_source ?? ''); ?>
...
</div><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/leads/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>