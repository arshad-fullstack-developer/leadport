        ...
        <div class="form-group m-b-0">
            <div class="col-sm-12 text-center">
                <p><?php echo e(cleanLang(__('lang.already_have_an_account'))); ?>
                    ...
                    <a href="<?php echo e(url('login')); ?>" class="text-info m-l-5" data-target="login-forms-login">
...
<?php echo $__env->make('layout.wrapperplain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/authentication/signup.blade.php ENDPATH**/ ?>