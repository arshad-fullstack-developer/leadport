    ...
    <script>
        NX.admin_home_chart_income = JSON.parse('<?php echo json_encode(_clean($payload["income"]["monthly"])); ?>', true);
        NX.admin_home_chart_expenses = JSON.parse('<?php echo json_encode(_clean($payload["expenses"]["monthly"])); ?>', true);
        NX.admin_home_c3_leads_title = "<?php echo e($payload['leads_chart_center_title']); ?>";
    </script><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/home/admin/widgets/second-row/income.blade.php ENDPATH**/ ?>