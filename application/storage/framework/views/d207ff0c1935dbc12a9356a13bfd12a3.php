...
<div class="card">
    <div class="card-body" id="landlord-settings-form">
        ...
        <div class="form-group row">
            ...
            <div class="col-12">
                ...
                <select class="select2-basic form-control form-control-sm select2-preselected"
                    id="settings_system_currency_code"
                    data-preselected="<?php echo e($settings->settings_system_currency_code ?? ''); ?>"
        ...
        <div class="form-group row">
            ...
            <div class="col-12">
                <input type="text" class="form-control form-control-sm" id="settings_system_currency_symbol"
                    name="settings_system_currency_symbol" value="<?php echo e($settings->settings_system_currency_symbol); ?>">
            </div>
        </div>
            ...
            <div class="col-12">
                <select class="select2-basic form-control form-control-sm" id="settings_system_decimal_separator"
                    ...
                    <option value="fullstop"
                        <?php echo e(runtimePreselected('fullstop', $settings->settings_system_decimal_separator ?? '')); ?>>
                        . (<?php echo e(cleanLang(__('lang.full_stop'))); ?>)</option>
                    <option value="comma"
                        <?php echo e(runtimePreselected('comma', $settings->settings_system_decimal_separator ?? '')); ?>>
        ...
        <div class="form-group row">
            <label class="col-12 control-label col-form-label"><?php echo e(cleanLang(__('lang.thousands_separator'))); ?></label>
            <div class="col-12">
                <select class="select2-basic form-control form-control-sm" id="settings_system_thousand_separator"
                    ...
                    <option value="fullstop"
                        <?php echo e(runtimePreselected('fullstop', $settings->settings_system_thousand_separator ?? '')); ?>>
                        . (<?php echo e(cleanLang(__('lang.full_stop'))); ?>)</option>
                    <option value="comma"
                        <?php echo e(runtimePreselected('comma', $settings->settings_system_thousand_separator ?? '')); ?>>
                        , (<?php echo e(cleanLang(__('lang.comma'))); ?>)</option>
                    <option value="apostrophe"
                        <?php echo e(runtimePreselected("apostrophe", $settings->settings_system_thousand_separator ?? '')); ?>>
                        ' (<?php echo e(cleanLang(__('lang.apostrophe'))); ?>)</option>
                    <option value="none"
                        <?php echo e(runtimePreselected('none', $settings->settings_system_thousand_separator ?? '')); ?>>
                        <?php echo e(cleanLang(__('lang.none'))); ?></option>
                    <option value="space"
                        <?php echo e(runtimePreselected('space', $settings->settings_system_thousand_separator ?? '')); ?>>
        ...
        <div class="form-group row">
            ...
            <div class="col-12">
                <select class="select2-basic form-control form-control-sm" id="settings_system_currency_position"
                    ...
                    <option value="left"
                        <?php echo e(runtimePreselected('left', $settings->settings_system_currency_position ?? '')); ?>>
                        <?php echo e(cleanLang(__('lang.left'))); ?></option>
                    <option value="right"
                        <?php echo e(runtimePreselected('right', $settings->settings_system_currency_position ?? '')); ?>>
        ...
        <div class="text-right">
            <button type="submit" id="commonModalSubmitButton"
                ...
                data-url="<?php echo e(url('app-admin/settings/currency')); ?>" data-form-id="landlord-settings-form"
...
<?php echo $__env->make('landlord.settings.wrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/landlord/settings/sections/currency/page.blade.php ENDPATH**/ ?>