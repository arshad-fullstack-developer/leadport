...
<div class="col-md-12  col-lg-7 p-b-9 align-self-center text-right <?php echo e($page['list_page_actions_size'] ?? ''); ?> <?php echo e($page['list_page_container_class'] ?? ''); ?>"
    ...
    <div id="list-page-actions">
        ...
        <!--ARCHIVED TICKETS-->
        <?php if(config('visibility.archived_tickets_toggle_button')): ?>
        <button type="button" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.show_archive_tickets'))); ?>"
            id="pref_filter_show_archived_tickets"
            class="list-actions-button btn btn-page-actions waves-effect waves-dark js-ajax-ux-request <?php echo e(runtimeActive(auth()->user()->pref_filter_show_archived_tickets)); ?>"
            data-url="<?php echo e(urlResource('/tickets/search?action=search&toggle=pref_filter_show_archived_tickets')); ?>">
...
</div><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/tickets/components/misc/list-page-actions.blade.php ENDPATH**/ ?>