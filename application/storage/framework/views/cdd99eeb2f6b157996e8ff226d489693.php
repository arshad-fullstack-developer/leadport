    ...
    <form>
        <div class="slimscrollright">
            ...
            <div class="rpanel-title">
                <i class="icon-Filter-2"></i><?php echo e(cleanLang(__('lang.filter_contacts'))); ?>
            ...
            <div class="r-panel-body">
                ...
                <div class="filter-block">
                    <div class="title">
                        <?php echo e(cleanLang(__('lang.name'))); ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <select name="filter_name" id="filter_name"
                                    class="form-control form-control-sm js-select2-basic-search select2-multiple select2-hidden-accessible"
                                    multiple="multiple" tabindex="-1" aria-hidden="true"
                                    data-ajax--url="<?php echo e(url('/')); ?>/feed/contacts?type=client"></select>
                                <!--select2 basic search-->
                            </div>
                        </div>
                    </div>
                ...
                <div class="filter-block">
                    <div class="title">
                        <?php echo e(cleanLang(__('lang.email_address'))); ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <select name="filter_email" id="filter_email"
                                    class="form-control form-control-sm js-select2-basic-search select2-multiple select2-hidden-accessible"
                                    multiple="multiple" tabindex="-1" aria-hidden="true"
                                    data-ajax--url="<?php echo e(url('/')); ?>/feed/email?type=client"></select>
                                <!--select2 basic search-->
                            </div>
                        </div>
                    </div>
                ...
                <div class="filter-block">
                    <div class="title">
                        <?php echo e(cleanLang(__('lang.user_type'))); ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <select name="filter_account_owner" id="filter_account_owner"
                                    ...
                                    multiple="multiple" tabindex="-1" aria-hidden="true">
                                    <option value="yes"><?php echo e(cleanLang(__('lang.account_owner'))); ?></option>
                                    <option value="no"><?php echo e(cleanLang(__('lang.user'))); ?></option>
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="buttons-block">
                    ...
                    <button type="button" class="btn btn-rounded-x btn-success js-ajax-ux-request apply-filter-button"
                        data-url="<?php echo e(urlResource('/contacts/search')); ?>" data-type="form" data-ajax-type="GET"><?php echo e(cleanLang(__('lang.apply_filter'))); ?></button>
                </div>
...
<!--sidebar--><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/contacts/components/misc/filter-contacts.blade.php ENDPATH**/ ?>