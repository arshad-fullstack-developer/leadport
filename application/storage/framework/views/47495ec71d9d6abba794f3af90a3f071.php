<div class="setup-welcome" id="setup-welcome">
    ...
    <div class="x-button m-t-30">
        <button type="button" class="btn waves-effect waves-light btn-block btn-info js-ajax-request"
            ...
            data-ajax-type="post"
            data-url="<?php echo e(url('install/requirements')); ?>">Start Installation</button>
    </div>

</div><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/install/welcome.blade.php ENDPATH**/ ?>