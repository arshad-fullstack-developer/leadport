...
<div class="col-md-12  col-lg-7 p-b-9 align-self-center text-right <?php echo e($page['list_page_actions_size'] ?? ''); ?> <?php echo e($page['list_page_container_class'] ?? ''); ?>"
    ...
    <div id="list-page-actions">
        ...
        <button type="button" data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.filter'))); ?>"
            ...
            data-target="sidepanel-filter-canned">
        ...
        <button type="button" id="canned-add-button"
            ...
            data-url="<?php echo e(url('canned/create')); ?>"
            data-loading-target="commonModalBody" 
            data-modal-title="<?php echo app('translator')->get('lang.add_canned'); ?>"
            data-action-url="<?php echo e(url('canned')); ?>"
...
</div><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/canned/components/misc/list-page-actions.blade.php ENDPATH**/ ?>