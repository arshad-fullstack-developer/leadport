    ...
    <div class="card-body" id="landlord-settings-form">
        ...
        <div class="text-right">
            ...
            <button type="submit" id="submitButton"
                ...
                data-url="<?php echo e(url('app-admin/settings/smtp')); ?>" data-form-id="landlord-settings-form"
    ...
    <div class="col-12">
        <div class="alert alert-info m-t-40 p-t-30 p-b-30">
            <div class="email-testing-tool-sections" id="email-testing-tool-start">
                ...
                <a href="#" class="btn btn-sm btn-primary ajax-request" data-url="<?php echo e(url('app-admin/settings/testsmtp')); ?>"
...
<?php echo $__env->make('landlord.settings.wrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/landlord/settings/sections/smtp/page.blade.php ENDPATH**/ ?>