...
<div class="kanban-card kanban-board-element show-modal-button reset-card-modal-form js-ajax-ux-request"
    ...
    <div class="x-meta">
        ...
        <label class="label <?php echo e(runtimeTaskPriorityColors($task->task_priority, 'label')); ?> p-t-3 p-b-3 p-l-8 p-r-8 custum"
            data-toggle="tooltip"
            title="<?php echo e(cleanLang(__('lang.transport'))); ?>"><?php echo e(cleanLang(__('lang.transport'))); ?></label>
        <?php endif; ?>
        ...
        <div class="wrap-words" id="reminder_card_view_container_<?php echo e($task->task_id ?? ''); ?>">
            <?php if(isset($task->reminders) && count($task->reminders) > 0): ?>
