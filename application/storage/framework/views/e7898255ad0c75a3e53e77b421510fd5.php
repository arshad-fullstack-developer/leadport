...
<script type="text/javascript" src="<?php echo e(asset('public/js/codemirror/codemirror.min.js?v=')); ?> <?php echo e(config('system.versioning')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('public/js/codemirror/css.min.js?v=')); ?> <?php echo e(config('system.versioning')); ?>"></script>
