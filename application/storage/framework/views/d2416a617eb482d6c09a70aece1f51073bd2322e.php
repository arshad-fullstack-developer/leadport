...
<tr id="lead_<?php echo e($lead->lead_id); ?>">
    ...
    <td class="col_lead_firstname <?php echo e(config('table.tableconfig_column_1')); ?> tableconfig_column_1" id="leads_col_contact_<?php echo e($lead->lead_id); ?>">
    ...
    <td class="col_lead_title <?php echo e(config('table.tableconfig_column_2')); ?> tableconfig_column_2" id="leads_col_title_<?php echo e($lead->lead_id); ?>">
    ...
    <td class="col_lead_created <?php echo e(config('table.tableconfig_column_3')); ?> tableconfig_column_3" id="leads_col_date_<?php echo e($lead->lead_id); ?>">
    ...
    <td class="col_lead_value <?php echo e(config('table.tableconfig_column_4')); ?> tableconfig_column_4" id="leads_col_value_<?php echo e($lead->lead_id); ?>">
    ...
    <td class="leads_col_assigned <?php echo e(config('table.tableconfig_column_6')); ?> tableconfig_column_6" id="leads_col_assigned_<?php echo e($lead->lead_id); ?>">
        <!--assigned users-->
    ...
    <td class="col_lead_category_name <?php echo e(config('table.tableconfig_column_7')); ?> tableconfig_column_7" id="col_lead_category_name_<?php echo e($lead->lead_id); ?>">
    ...
    <td class="col_lead_status <?php echo e(config('table.tableconfig_column_5')); ?> tableconfig_column_5" id="leads_col_stage_<?php echo e($lead->lead_id); ?>">
    ...
    <td class="col_lead_company_name <?php echo e(config('table.tableconfig_column_8')); ?> tableconfig_column_8" id="col_lead_company_name_<?php echo e($lead->lead_id); ?>">
    ...
    <td class="col_lead_email <?php echo e(config('table.tableconfig_column_9')); ?> tableconfig_column_9" id="col_lead_email_<?php echo e($lead->lead_id); ?>">
    ...
    <td class="col_lead_phone <?php echo e(config('table.tableconfig_column_10')); ?> tableconfig_column_10" id="col_lead_phone_<?php echo e($lead->lead_id); ?>">
    ...
    <td class="col_lead_job_position <?php echo e(config('table.tableconfig_column_11')); ?> tableconfig_column_11" id="col_lead_job_position_<?php echo e($lead->lead_id); ?>">
    ...
    <td class="col_lead_city <?php echo e(config('table.tableconfig_column_12')); ?> tableconfig_column_12" id="col_lead_city_<?php echo e($lead->lead_id); ?>">
    ...
    <td class="col_lead_state <?php echo e(config('table.tableconfig_column_13')); ?> tableconfig_column_13" id="col_lead_state_<?php echo e($lead->lead_id); ?>">
    ...
    <td class="col_lead_zip <?php echo e(config('table.tableconfig_column_14')); ?> tableconfig_column_14" id="col_lead_zip_<?php echo e($lead->lead_id); ?>">
    ...
    <td class="col_lead_country <?php echo e(config('table.tableconfig_column_15')); ?> tableconfig_column_15" id="col_lead_country_<?php echo e($lead->lead_id); ?>">
    ...
    <td class="col_lead_last_contacted <?php echo e(config('table.tableconfig_column_16')); ?> tableconfig_column_16" id="col_lead_last_contacted_<?php echo e($lead->lead_id); ?>">
    ...
    <td class="col_lead_converted_by_userid <?php echo e(config('table.tableconfig_column_17')); ?> tableconfig_column_17" id="col_lead_converted_by_userid_<?php echo e($lead->lead_id); ?>">
    ...
    <td class="col_lead_converted_date <?php echo e(config('table.tableconfig_column_18')); ?> tableconfig_column_18" id="lead_converted_date_<?php echo e($lead->lead_id); ?>">
    ...
    <td class="col_lead_source <?php echo e(config('table.tableconfig_column_19')); ?> tableconfig_column_19" id="col_lead_source_<?php echo e($lead->lead_id); ?>">
    ...
    <td class="leads_col_action actions_column" id="leads_col_action_<?php echo e($lead->lead_id); ?>">
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <button type="button" title="<?php echo e(cleanLang(__('lang.assigned_users'))); ?>"
                ...
                data-toggle="modal" data-target="#commonModal"
                data-url="<?php echo e(urlResource('/leads/'.$lead->lead_id.'/assigned')); ?>"
                data-loading-target="commonModalBody" data-modal-title="<?php echo e(cleanLang(__('lang.assigned_users'))); ?>"
                data-action-url="<?php echo e(urlResource('/leads/'.$lead->lead_id.'/assigned')); ?>"
                data-action-method="PUT" data-modal-size="modal-sm" data-action-ajax-class="ajax-request"
                data-action-ajax-class="" data-action-ajax-loading-target="leads-td-container">
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<!--each row--><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/leads/components/table/ajax.blade.php ENDPATH**/ ?>