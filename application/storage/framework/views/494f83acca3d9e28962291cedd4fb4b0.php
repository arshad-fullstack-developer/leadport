    ...
    <div class="pull-right invoice-dues">
        <table>
            <tr>
                ...
                <td class="x-payments"> <span class="p-l-20"><?php echo runtimeMoneyFormatPDF(0.00); ?></span> </td>
                <?php endif; ?>
            </tr>
            <tr>
    ...
    </div><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/bill/components/elements/invoice/payments.blade.php ENDPATH**/ ?>