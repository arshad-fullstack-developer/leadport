...
<div class="col-sm-12 col-md-4 col-lg-3" id="category_<?php echo e($category->kbcategory_id ?? ''); ?>">
    <div class="card kb-category">
        <div class="card-body">
            ...
            <!--description-->
            <div class="card-text"><?php echo $category->kbcategory_description ?? '---'; ?></div>
...
<?php endif; ?><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/kbcategories/components/list/ajax.blade.php ENDPATH**/ ?>