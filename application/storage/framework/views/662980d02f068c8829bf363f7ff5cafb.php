...
<div class="card">
    <div class="card-body" id="landlord-settings-form">
        ...
        <div class="alert alert-info"><?php echo app('translator')->get('lang.account_settings_info'); ?></div>
        ...
        <form class="form" id="settingsFormGeneral">
            ...
            <div class="form-group row">
                ...
                <div class="col-12">
                    <select class="select2-basic form-control form-control-sm" id="defaults_language_default"
                        name="defaults_language_default">
                        ...
                        <option value="<?php echo e($language); ?>"
                            <?php echo e(runtimePreselected($language, $defaults->defaults_language_default ?? '')); ?>>
                            <?php echo e(ucwords($language)); ?></option>
            ...
            <div class="form-group row">
                ...
                <div class="col-12">
                    <select class="select2-basic-with-search form-control form-control-sm select2-preselected"
                        data-allow-clear="false" id="defaults_timezone" name="defaults_timezone"
                        data-preselected="<?php echo e($defaults->defaults_timezone ?? ''); ?>">
                        <optgroup label="UTC">
            ...
            <div class="form-group row">
                ...
                <div class="col-12">
                    <select class="select2-basic form-control form-control-sm" id="defaults_date_format"
                        name="defaults_date_format">
                        <option value="d-m-Y" <?php echo e(runtimePreselected('d-m-Y', $defaults->defaults_date_format ?? '')); ?>>
                            d-m-Y</option>
                        <option value="d/m/Y" <?php echo e(runtimePreselected('d/m/Y', $defaults->defaults_date_format ?? '')); ?>>
                            d/m/Y</option>
                        <option value="m-d-Y" <?php echo e(runtimePreselected('m-d-Y', $defaults->defaults_date_format ?? '')); ?>>
                            m-d-Y</option>
                        <option value="m/d/Y" <?php echo e(runtimePreselected('m/d/Y', $defaults->defaults_date_format ?? '')); ?>>
                            m/d/Y</option>
                        <option value="Y-m-d" <?php echo e(runtimePreselected('Y-m-d', $defaults->defaults_date_format ?? '')); ?>>
                            Y-m-d</option>
                        <option value="Y/m/d" <?php echo e(runtimePreselected('Y/m/d', $defaults->defaults_date_format ?? '')); ?>>
                            Y/m/d</option>
                        <option value="Y-d-m" <?php echo e(runtimePreselected('Y-d-m', $defaults->defaults_date_format ?? '')); ?>>
                            Y-d-m</option>
                        <option value="Y/d/m" <?php echo e(runtimePreselected('Y/d/m', $defaults->defaults_date_format ?? '')); ?>>
                            Y/d/m</option>
                    </select>
            ...
            <div class="form-group row">
                ...
                <div class="col-12">
                    <select class="select2-basic form-control form-control-sm" id="defaults_datepicker_format"
                        name="defaults_datepicker_format">
                        <option value="dd-mm-yyyy"
                            <?php echo e(runtimePreselected('dd-mm-yyyy', $defaults->defaults_datepicker_format ?? '')); ?>>
                            dd-mm-yyyy</option>
                        <option value="mm-dd-yyyy"
                            <?php echo e(runtimePreselected('mm-dd-yyyy', $defaults->defaults_datepicker_format ?? '')); ?>>
                            mm-dd-yyyy</option>
                    </select>
                </div>
            </div>
            ...
            <!--currencies-->
            <div class="form-group row">
                <label class="col-12 control-label col-form-label"><?php echo e(cleanLang(__('lang.currency_code'))); ?></label>
                <div class="col-12">
                    ...
                    <select class="select2-basic form-control form-control-sm select2-preselected"
                        id="defaults_currency_code" data-preselected="<?php echo e($defaults->defaults_currency_code ?? ''); ?>"
                        name="defaults_currency_code">
                        <option></option>
            ...
            <!--currency symbol-->
            <div class="form-group row">
                <label class="col-12 control-label col-form-label"><?php echo e(cleanLang(__('lang.currency_symbol'))); ?></label>
                <div class="col-12">
                    <input type="text" class="form-control form-control-sm" id="defaults_currency_symbol"
                        name="defaults_currency_symbol" value="<?php echo e($defaults->defaults_currency_symbol); ?>">
                </div>
            </div>
            ...
            <div class="form-group row">
                <label class="col-12 control-label col-form-label"><?php echo e(cleanLang(__('lang.decimal_separator'))); ?></label>
                <div class="col-12">
                    <select class="select2-basic form-control form-control-sm" id="defaults_decimal_separator"
                        name="defaults_decimal_separator">
                        <option value="fullstop"
                            <?php echo e(runtimePreselected('fullstop', $defaults->defaults_decimal_separator ?? '')); ?>>
                            . (<?php echo e(cleanLang(__('lang.full_stop'))); ?>)</option>
                        <option value="comma"
                            <?php echo e(runtimePreselected('comma', $defaults->defaults_decimal_separator ?? '')); ?>>
                            , (<?php echo e(cleanLang(__('lang.comma'))); ?>)</option>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group row">
                <label
                    class="col-12 control-label col-form-label"><?php echo e(cleanLang(__('lang.thousands_separator'))); ?></label>
                <div class="col-12">
                    <select class="select2-basic form-control form-control-sm" id="defaults_thousand_separator"
                        name="defaults_thousand_separator">
                        <option value="fullstop"
                            <?php echo e(runtimePreselected('fullstop', $defaults->defaults_thousand_separator ?? '')); ?>>
                            . (<?php echo e(cleanLang(__('lang.full_stop'))); ?>)</option>
                        <option value="comma"
                            <?php echo e(runtimePreselected('comma', $defaults->defaults_thousand_separator ?? '')); ?>>
                            , (<?php echo e(cleanLang(__('lang.comma'))); ?>)</option>
                        <option value="apostrophe"
                            <?php echo e(runtimePreselected("apostrophe", $defaults->defaults_thousand_separator ?? '')); ?>>
                            ' (<?php echo e(cleanLang(__('lang.apostrophe'))); ?>)</option>
                        <option value="none"
                            <?php echo e(runtimePreselected('none', $defaults->defaults_thousand_separator ?? '')); ?>>
                            <?php echo e(cleanLang(__('lang.none'))); ?></option>
                        <option value="space"
                            <?php echo e(runtimePreselected('space', $defaults->defaults_thousand_separator ?? '')); ?>>
                            <?php echo e(cleanLang(__('lang.space'))); ?></option>
                    </select>
            ...
            <div class="form-group row">
                <label for="example-month-input"
                    class="col-12 col-form-label text-left"><?php echo e(cleanLang(__('lang.currency_symbol_position'))); ?></label>
                <div class="col-12">
                    <select class="select2-basic form-control form-control-sm" id="defaults_currency_position"
                        name="defaults_currency_position">
                        <option value="left"
                            <?php echo e(runtimePreselected('left', $defaults->defaults_currency_position ?? '')); ?>>
                            <?php echo e(cleanLang(__('lang.left'))); ?></option>
                        <option value="right"
                            <?php echo e(runtimePreselected('right', $defaults->defaults_currency_position ?? '')); ?>>
                            <?php echo e(cleanLang(__('lang.right'))); ?></option>
                    </select>
                </div>
            </div>

            <!--defaults_email_delivery-->
            <div class="form-group row">
                <label for="example-month-input"
                    class="col-12 col-form-label text-left"><?php echo e(cleanLang(__('lang.email_delivery'))); ?></label>
                <div class="col-12">
                    <select class="select2-basic form-control form-control-sm" id="defaults_email_delivery"
                        name="defaults_email_delivery">
                        <option value="smtp_only"
                            <?php echo e(runtimePreselected('smtp_only', $defaults->defaults_email_delivery ?? '')); ?>>
                            <?php echo e(cleanLang(__('lang.smtp_only'))); ?></option>
                        <option value="smtp_and_sendmail"
                            <?php echo e(runtimePreselected('smtp_and_sendmail', $defaults->defaults_email_delivery ?? '')); ?>>
                            <?php echo e(cleanLang(__('lang.smtp_and_sendmail'))); ?></option>
                    </select>
                </div>
            </div>
            ...
            <div class="text-right m-t-30">
                <button type="submit" id="commonModalSubmitButton"
                    ...
                    data-url="<?php echo e(url('app-admin/settings/defaults')); ?>" data-form-id="landlord-settings-form"
...
<?php echo $__env->make('landlord.settings.wrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/landlord/settings/sections/defaults/page.blade.php ENDPATH**/ ?>