<head>
    ...
    <script src="<?php echo e(asset('public/vendor/js/vendor.header.js?v=' . config('system.versioning'))); ?>"></script>
    ...
    <!--[if lt IE 9]>
    <script src="<?php echo e(asset('public/vendor/js/html5shiv/html5shiv.js')); ?>"></script>
    <script src="<?php echo e(asset('public/vendor/js/respond/respond.min.js')); ?>"></script>
    <![endif]-->
    ...
    <!--VENDORS CSS-->
    <link rel="stylesheet" href="<?php echo e(asset('public/vendor/css/vendor.css?v=' . config('system.versioning'))); ?>">

    <!--ICONS-->
    <link rel="stylesheet" href="<?php echo e(asset('public/vendor/fonts/growcrm-icons/styles.css?v=' . config('system.versioning'))); ?>">

    <!--THEME STYLE-->
    <?php if(config('visibility.external_view_use_default_theme')): ?>
    <link href="<?php echo e(asset('themes/default/css/style.css?v=' . config('system.settings_system_javascript_versioning'))); ?>" rel="stylesheet">
    <?php else: ?>
    <?php if(auth()->check()): ?>
    <link href="<?php echo e(asset('public/themes/' . auth()->user()->pref_theme . '/css/style.css?v=' . config('system.settings_system_javascript_versioning'))); ?>" rel="stylesheet">
    <?php else: ?>
    <link href="<?php echo e(asset(config('theme.selected_theme_css'))); ?>" rel="stylesheet">
    <?php endif; ?>
    <?php endif; ?>

    <!--USERS CUSTOM CSS FILE-->
    <link href="<?php echo e(asset('public/css/custom.css?v=' . config('system.versioning'))); ?>" rel="stylesheet">

    <!--PRINTING CSS-->
    <link href="<?php echo e(asset('public/css/print.css?v=' . config('system.versioning'))); ?>" rel="stylesheet">
    ...
    <script type="text/javascript">
        ...
        NXLANG.dimensions_default_unit = "<?php echo e(config('system.settings2_extras_dimensions_default_unit')); ?>"
        NXLANG.tax = "<?php echo e(cleanLang(__('lang.tax'))); ?>";
    ...
    <!--boot js-->
    <script src="<?php echo e(asset('public/js/core/head.js?v=' . config('system.versioning'))); ?>"></script>
    ...
    <!--tap payments js-->
    <?php if(config('visibility.tap_gateway_js')): ?>
...
<?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/layout/header.blade.php ENDPATH**/ ?>