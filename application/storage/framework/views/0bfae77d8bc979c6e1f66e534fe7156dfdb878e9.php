...
<div class="form-group row">
    ...
    <div class="col-12">
        <select class="select2-basic form-control form-control-sm select2-preselected a-custom-field" id="<?php echo e($field->customfields_name); ?>"
            ...
            <option value=""></option>
            <?php echo _clean(runtimeCustomFieldsJsonLists($field->customfields_datapayload)); ?>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/tickets/components/create/customfields.blade.php ENDPATH**/ ?>