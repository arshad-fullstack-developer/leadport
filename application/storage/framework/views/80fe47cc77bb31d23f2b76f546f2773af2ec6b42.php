...
<div class="x-description"><?php echo _clean($event->event_item_content); ?></div>
<?php endif; ?>
...
<div class="x-description"><a href="<?php echo e(url('tickets/'.$event->event_item_id)); ?>"><?php echo _clean($event->event_item_content); ?></a>
</div>
<?php endif; ?>

<!--invoice-->
<?php if($event->event_item == 'invoice'): ?>
<div class="x-description"><a href="<?php echo e(url('invoices/'.$event->event_item_id)); ?>"><?php echo _clean($event->event_item_content); ?></a>
</div>
<?php endif; ?>
...
<div class="x-description"><a href="<?php echo e(url('estimates/'.$event->event_item_id)); ?>"><?php echo _clean($event->event_item_content); ?></a>
</div>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/events/includes/content.blade.php ENDPATH**/ ?>