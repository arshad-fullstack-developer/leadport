<div class="col-12 align-self-center hidden checkbox-actions box-shadow-minimum" id="contracts-checkbox-actions-container">
    ...
    <div class="x-buttons">
        ...
        <button type="button" class="btn btn-sm btn-default waves-effect waves-dark confirm-action-danger"
            data-type="form" data-ajax-type="POST" data-form-id="contracts-list-table" data-url="<?php echo e(url('/contracts/delete')); ?>"
        ...
        <button type="button"
            ...
            data-url="<?php echo e(urlResource('/contracts/change-category')); ?>" 
            data-action-url="<?php echo e(urlResource('/contracts/change-category')); ?>"
    ...
    <?php endif; ?>
</div><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/contracts/components/actions/checkbox-actions.blade.php ENDPATH**/ ?>