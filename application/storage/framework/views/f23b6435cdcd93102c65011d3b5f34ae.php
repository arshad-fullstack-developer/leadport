        ...
        <div class="bill-file-attachments-wrapper" id="bill-file-attachments-wrapper">
            ...
            <div class="x-add-file-button">
                <button type="button" id="bill-file-attachments-upload-button"
                    class="btn waves-effect waves-light btn-rounded btn-xs btn-success"><?php echo app('translator')->get('lang.add_file_attachments'); ?></button>
            </div>
            <?php endif; ?>
        </div>
        <!--dropzone-->
...
</div><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/bill/components/elements/totals-table.blade.php ENDPATH**/ ?>