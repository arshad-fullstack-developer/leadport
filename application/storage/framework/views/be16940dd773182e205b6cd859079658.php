        ...
        <div class="bill-addresses">
            ...
            <table>
                <tbody>
                    <tr>
                        <td class="p-t-10">
                            <strong><?php echo app('translator')->get('lang.project'); ?>:</strong> <?php echo e($bill->project_title); ?>
...
</html><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/bill/bill-pdf.blade.php ENDPATH**/ ?>