        ...
        <div class="form-group row">
            <div class="col-12">
                <input name="milestone_colors" type="radio" id="radio_default" value="default"
                    ...
                    <?php echo e(runtimePreChecked2('default', $milestone->milestone_color ?? '')); ?>
            ...
            <div class="col-12 p-b-5">
                <input name="milestone_colors" type="radio" id="radio_info" value="info"
                    <?php echo e(runtimePreChecked2('info', $milestone->milestone_color ?? '')); ?>
            ...
            <div class="col-12">
                <input name="milestone_colors" type="radio" id="radio_success" value="success"
                    <?php echo e(runtimePreChecked2('success', $milestone->milestone_color ?? '')); ?>
            ...
            <div class="col-12">
                <input name="milestone_colors" type="radio" id="radio_danger" value="danger"
                    <?php echo e(runtimePreChecked2('danger', $milestone->milestone_color ?? '')); ?>
            ...
            <div class="col-12">
                <input name="milestone_colors" type="radio" id="radio_warning" value="warning"
                    <?php echo e(runtimePreChecked2('warning', $milestone->milestone_color ?? '')); ?>
            ...
            <div class="col-12">
                <input name="milestone_colors" type="radio" id="radio_primary" value="primary"
                    <?php echo e(runtimePreChecked2('primary', $milestone->milestone_color ?? '')); ?>
            ...
            <div class="col-12">
                <input name="milestone_colors" type="radio" id="radio_lime" value="lime"
                    <?php echo e(runtimePreChecked2('lime', $milestone->milestone_color ?? '')); ?>
            ...
            <div class="col-12">
                <input name="milestone_colors" type="radio" id="radio_brown" value="brown"
                    <?php echo e(runtimePreChecked2('brown', $milestone->milestone_color ?? '')); ?>
            ...
            <!--hidden-->
            <input type="hidden" name="milestone_color" id="milestone_color" value="<?php echo e($milestone->milestone_color ?? 'default'); ?>">

        </div>
    </div>
<?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/milestones/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>