<div class="reports-list-page-filter-container">
    <form class="form-inline row gy-2 gx-3 align-items-center" id="reports-list-page-filter-form">
        ...
        <!--status-->
        <div class="form-group row">
            <select name="filter_project_status" id="filter_project_status" style="width:200px;"
                ...
                <option value="completed"><?php echo app('translator')->get('lang.completed'); ?></option>
            </select>
        </div>
        ...
        <div class="col-auto">
            ...
            <button type="submit" id="submitButton" class="btn btn-info btn-sm waves-effect text-left ajax-request"
                data-url="<?php echo e(url('report/projects/overview?action=load')); ?>"
...
</div><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/reports/projects/client/filter.blade.php ENDPATH**/ ?>