...
<div class="col-md-12  col-lg-7 p-b-9 align-self-center text-right <?php echo e($page['list_page_actions_size'] ?? ''); ?> <?php echo e($page['list_page_container_class'] ?? ''); ?>"
    ...
    <div id="list-page-actions">
        ...
        <button type="button" title="<?php echo e(cleanLang(__('lang.import_clients'))); ?>" id="clients-import-button"
            ...
            data-action-url="<?php echo e(url('import/clients')); ?>" data-action-method="POST"
            data-loading-target="commonModalBody" data-action-ajax-loading-target="commonModalBody"
            data-modal-title="<?php echo app('translator')->get('lang.import_clients'); ?>" data-url="<?php echo e(url('import/clients/create')); ?>">
            <i class="ti-import"></i>
        </button>
        <?php endif; ?>
        ...
        <button type="button" data-toggle="tooltip" title="<?php echo app('translator')->get('lang.export_clients'); ?>"
...
</div><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/clients/components/misc/list-page-actions.blade.php ENDPATH**/ ?>