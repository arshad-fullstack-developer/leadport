...
<aside class="left-sidebar" id="js-trigger-nav-team">
        ...
        <nav class="sidebar-nav" id="main-sidenav">
            <ul id="sidebarnav" data-modular-id="main_menu_team">
                ...
                <li data-modular-id="main_menu_team_messages"
                    ...
                    <a class="waves-effect waves-dark p-r-20" href="<?php echo e(url('/messages')); ?>" aria-expanded="false" target="_self">
                ...
                <li data-modular-id="main_menu_team_contracts"
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li class="sidenav-submenu <?php echo e($page['submenu_canned'] ?? ''); ?>"
                            id="submenu_contract_templates">
                ...
                <li data-modular-id="main_menu_team_knowledgebase"
                    ...
                    <a class="waves-effect waves-dark p-r-20" href="<?php echo e(url('/knowledgebase')); ?>" aria-expanded="false"
                        target="_self">
    ...
    <!-- End Sidebar scroll-->
</aside><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/nav/leftmenu-team.blade.php ENDPATH**/ ?>