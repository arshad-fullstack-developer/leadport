    ...
    <table class="table table-hover no-wrap" id="report-results-table">
        <thead>
            <tr>
                ...
                <!--bill_invoiceid-->
                <th class="col_bill_invoiceid"><a href="javascript:void(0)"><?php echo app('translator')->get('lang.id'); ?><span
                ...
                <th class="col_bill_final_amount"><a href="javascript:void(0)"><?php echo app('translator')->get('lang.total'); ?><span
                            class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a></th>
                <!--payments-->
                <th class="col_payments"><a href="javascript:void(0)"><?php echo app('translator')->get('lang.payments'); ?><span
                            class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a></th>
                <!--amount_due-->
                <th class="col_amount_due"><a href="javascript:void(0)"><?php echo app('translator')->get('lang.due'); ?><span
                            class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a></th>
                <!--bill_status-->
        ...
        <tbody id="report-results-ajax-container">
            <!--rows-->
            <?php echo $__env->make('pages.reports.invoices.overview.ajax', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </tbody>
        <tfoot>
            <!--rows-->
            <?php echo $__env->make('pages.reports.invoices.overview.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </tfoot>
    </table>
...
<?php endif; ?><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/reports/invoices/overview/table.blade.php ENDPATH**/ ?>