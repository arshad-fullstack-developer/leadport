...
<div class="row">
    ...
    <div class="col-sm-12 col-md-4 col-lg-3" id="logfile_<?php echo e($key); ?>">
        <div class="error-log">
            ...
            <a type="button" href="<?php echo e(url('app-admin/settings/errorlogs/download?filename='.$log->getFilename())); ?>"
            ...
            <button type="button" class="btn btn-success btn-sm btn-xs confirm-action-danger"
                ...
                data-url="<?php echo e(url('app-admin/settings/errorlogs/delete?key='.$key.'&filename='.$log->getFilename())); ?>">
...
<?php echo $__env->make('landlord.settings.wrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/landlord/settings/sections/errorlogs/page.blade.php ENDPATH**/ ?>