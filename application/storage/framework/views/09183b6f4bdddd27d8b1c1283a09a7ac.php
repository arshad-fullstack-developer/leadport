...
<button type="submit" id="createCustomerButton" class="btn btn-rounded-x btn-success waves-effect text-left"
    ...
    data-ajax-type="post" data-type="form" data-form-id="convertLeadForm"><?php echo e(cleanLang(__('lang.submit'))); ?></button><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/lead/components/footer.blade.php ENDPATH**/ ?>