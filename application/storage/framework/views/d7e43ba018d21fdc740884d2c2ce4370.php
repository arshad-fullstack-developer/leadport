        ...
        <div class="form-group row">
            <div class="col-12">
                <textarea class="form-control form-control-sm tinymce-textarea" name="lead_mynotes"
                    id="lead_mynotes"><?php echo _clean($note->note_description ?? ''); ?></textarea>
            </div>
        </div>
    </div>

    <div class="form-group text-right">
        <button type="button" class="btn btn-success btn-xs ajax-request" data-loading-target="card-leads-left-panel"
...
</div><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/lead/content/mynotes/edit.blade.php ENDPATH**/ ?>