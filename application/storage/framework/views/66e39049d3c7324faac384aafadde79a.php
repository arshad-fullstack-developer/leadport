...
<form>
    ...
    <div class="alert alert-warning">
        <h5 class="text-warning"><i class="sl-icon-info"></i> <?php echo app('translator')->get('lang.warning'); ?></h5>
        <?php echo app('translator')->get('lang.changing_project_permissions_warning'); ?>
    </div>
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/settings/sections/projects/staff-permissions.blade.php ENDPATH**/ ?>