    ...
    <div class="row page-titles">
        ...
        <div class="col-md-12 col-lg-7 align-self-center <?php echo e($page['crumbs_special_class'] ?? ''); ?>" id="breadcrumbs">
            ...
            <a id="InvoiceTitleAttached"
                ...
                href="<?php echo e(_url('projects/'.$bill->bill_projectid)); ?>">
...
<?php echo $__env->make('layout.wrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/bill/wrapper.blade.php ENDPATH**/ ?>