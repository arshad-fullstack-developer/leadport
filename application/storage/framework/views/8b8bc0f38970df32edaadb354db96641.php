<div class="row project-details" id="project-details-container">
    <div class="col-sm-12 tinymce-transparent">
        ...
        <div class="project-description p-0 p-t-40 rich-text-formatting" id="project-description"> <?php echo $project->project_description; ?>
...
</div><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/project/components/tabs/details.blade.php ENDPATH**/ ?>