                        ...
                        <div class="x-option">
                            <div class="form-group form-group-checkbox row">
                                ...
                                <label for="client_type_existing"><span
                                        class="x-label-text"><?php echo app('translator')->get('lang.existing_client'); ?></span></label>
                            </div>
                        </div>
                        <div class="x-option">
                            <div class="form-group form-group-checkbox row">
                                ...
                                <label for="client_type_new"><span
                                        class="x-label-text"><?php echo app('translator')->get('lang.new_client'); ?></span></label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="option-existing-client-container" class="create-modal-option-contaiers hidden">
                            ...
                            <div class="text-right p-t-30">
                                <button type="submit" id="submitButton"
                                    ...
                                    disabled><?php echo app('translator')->get('lang.continue'); ?></button>
                            </div>
                        </div>
                        ...
                        <div id="option-new-client-container" class="create-modal-option-contaiers">
                            ...
                            <div class="text-right p-t-30">
                                <button type="submit" id="create-new-client-button"
                                    ...
                                    data-loading-target="create-modal-section-right"
                                    data-on-start-submit-button="disable"><?php echo app('translator')->get('lang.create_new_client'); ?></button>
                            </div>
                        </div>
...
</div><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/modals/create.blade.php ENDPATH**/ ?>