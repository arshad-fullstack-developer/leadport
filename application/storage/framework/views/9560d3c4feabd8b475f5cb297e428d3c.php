<div class="signup-form">
    ...
    <form class="form-horizontal form-material x-form p-t-30" id="loginForm" novalidate="novalidate" _lpchecked="1">
        <div class="input-group m-t-0 m-b-50">
            <input type="text" class="form-control" placeholder="<?php echo e($section->frontend_data_4); ?>" name="domain_name" aria-describedby="basic-addon2">
            <span class="input-group-addon x-sub-domain" id="basic-addon2">.<?php echo e(config('system.settings_base_domain')); ?></span>
        </div>
        <div class="form-group text-center m-t-10 p-b-10">
            <div class="col-xs-12">
                <button class="btn btn-info btn-lg btn-block position-relative ajax-request" id="loginSubmitButton"
                    ...
                    data-url="<?php echo e(url('account/login')); ?>" 
                    data-type="form" 
...
</div><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/frontend/signin/form.blade.php ENDPATH**/ ?>