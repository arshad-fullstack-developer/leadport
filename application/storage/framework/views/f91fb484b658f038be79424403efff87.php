        ...
        <div class="slimscrollright">
            ...
            <div class="r-panel-body documents-side-panel-billing-body  p-b-80">
                ...
                <div class="alert alert-info hidden" id="documents-side-panel-billing-info">
                    <h5 class="text-info"><i class="sl-icon-info"></i> <?php echo app('translator')->get('lang.info'); ?></h5>
                    <?php echo app('translator')->get('lang.documents_billing_info'); ?>
                    <div class="line"></div>
                    {pricing_table}
                </div>
...
<!--sidebar--><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/documents/editing/sidepanel-billing.blade.php ENDPATH**/ ?>