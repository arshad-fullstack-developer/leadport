...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <!--tickets table-->
            <?php echo $__env->make('pages.customtickets.components.table.wrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!--tickets table-->
        </div>
    </div>
    <!--page content -->
...
<?php echo $__env->make('layout.wrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/customtickets/wrapper.blade.php ENDPATH**/ ?>