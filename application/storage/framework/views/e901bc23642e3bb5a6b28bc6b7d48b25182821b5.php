    ...
    <div class="col-12">
        <div class="dropzone dz-clickable text-center file-upload-box" id="fileupload_landlord_logo">
            <div class="dz-default dz-message">
                ...
                <?php if(request('logo_size') == 'logo-large'): ?>
...
<!--section js resource-->
<span class="hidden" id="js-settings-logos-modal" data-size="<?php echo e(request('logo_size')); ?>">placeholder</span><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/landlord/settings/sections/logo/modals/update-logo.blade.php ENDPATH**/ ?>