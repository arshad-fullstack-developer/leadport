...
<ul class="nav nav-tabs" role="tablist">
        ...
        <li class="nav-item"> <a class="nav-link active ajax-request" data-toggle="tab" href="javascript:void(0);"
                        ...
                        data-tab-id="task-tab"><span
                                class="hidden-sm-up"><i class="ti-home"></i></span> <span
                                class="hidden-xs-down"><?php echo app('translator')->get('lang.task'); ?></span></a> </li>

        <!--customfields-->
        <!--<?php if(isset($task->transport_type) && $task->transport_type === 'transport'): ?>-->
        ...
        <!--                data-loading-class="loading-before-centre" data-loading-target="card-tasks-left-panel"-->
        <!--                data-tab-id="order-request-tab">-->
        <!--                <span class="hidden-sm-up"><i class="ti-menu"></i></span>-->
        <!--                <span class="hidden-xs-down"><?php echo app('translator')->get('lang.order_request'); ?></span></a>-->
        <!--</li>-->
        <!--<?php endif; ?>-->
...
<?php endif; ?><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/task/content/tabmenu.blade.php ENDPATH**/ ?>