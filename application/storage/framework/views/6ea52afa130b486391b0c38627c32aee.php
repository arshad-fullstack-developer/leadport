...
<div class="card">
    <div class="card-body" id="landlord-settings-form">
        ...
        <div class="form-group row">
            <label class="col-12 control-label col-form-label required"><?php echo e(cleanLang(__('lang.paypal_client_id'))); ?>

                (<?php echo app('translator')->get('lang.live'); ?>)* <span class="align-middle text-themecontrast font-16" data-toggle="tooltip"
                    title="<?php echo e(cleanLang(__('lang.paypal_general_info'))); ?>" data-placement="top"><i
                        class="ti-info-alt"></i></span></label>
            <div class="col-12">
                <input type="text" class="form-control form-control-sm" id="settings_paypal_live_client_id"
                    name="settings_paypal_live_client_id" value="<?php echo e($settings->settings_paypal_live_client_id ?? ''); ?>">
            </div>
        </div>

        <!--settings_paypal_live_secret_key-->
        <div class="form-group row">
            <label class="col-12 control-label col-form-label required"><?php echo e(cleanLang(__('lang.paypal_secret_key'))); ?>
            ...
            <div class="col-12">
                <input type="text" class="form-control form-control-sm" id="settings_paypal_live_secret_key"
                    ...
                    value="<?php echo e($settings->settings_paypal_live_secret_key ?? ''); ?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            <label class="col-12 control-label col-form-label required"><?php echo e(cleanLang(__('lang.paypal_client_id'))); ?>
                ...
                (<?php echo app('translator')->get('lang.sandbox'); ?>)* <span class="align-middle text-themecontrast font-16" data-toggle="tooltip"
                    title="<?php echo e(cleanLang(__('lang.paypal_general_info'))); ?>" data-placement="top"><i
                        class="ti-info-alt"></i></span></label>
            <div class="col-12">
                <input type="text" class="form-control form-control-sm" id="settings_paypal_sandbox_client_id"
                    ...
                    value="<?php echo e($settings->settings_paypal_sandbox_client_id ?? ''); ?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-12">
                <input type="text" class="form-control form-control-sm" id="settings_paypal_sandbox_secret_key"
                    ...
                    value="<?php echo e($settings->settings_paypal_sandbox_secret_key ?? ''); ?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-12">
                <input type="text" class="form-control form-control-sm" id="settings_stripe_ipn_url"
                    name="settings_stripe_ipn_url" value="<?php echo e(url('/app-admin/webhooks/paypal')); ?>" disabled>
            </div>
        </div>
        ...
        <div class="text-right">
            <button type="submit" id="commonModalSubmitButton"
                ...
                data-url="<?php echo e(url('app-admin/settings/paypal')); ?>" data-form-id="landlord-settings-form"
...
<?php echo $__env->make('landlord.settings.wrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/landlord/settings/sections/gateways/paypal/page.blade.php ENDPATH**/ ?>