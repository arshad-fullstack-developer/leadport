        ...
        <form class="form" id="settingsFormGeneral">
            ...
            <div class="form-group row">
                <label class="col-12 control-label col-form-label"><?php echo e(cleanLang(__('lang.purchase_code'))); ?>
                    ...
                    <span class="align-middle" data-toggle="tooltip"
                        title="<?php echo e(cleanLang(__('lang.product_purchase_code'))); ?>" data-placement="top"><i
                            class="ti-info-alt text-themecontrast"></i></span></label>
                <div class="col-12">
                    <input type="text" class="form-control form-control-sm" id="settings_purchase_code"
                        name="settings_purchase_code" value="<?php echo e($settings->settings_purchase_code ?? ''); ?>">
                </div>
            </div>
                ...
                <div class="col-12">
                    <select class="select2-basic form-control form-control-sm" id="settings_system_language_default"
                        ...
                        <option value="<?php echo e($language); ?>"
                            <?php echo e(runtimePreselected($language, $settings->settings_system_language_default ?? '')); ?>>
            ...
            <div class="form-group row">
                ...
                <div class="col-12">
                    <select class="select2-basic-with-search form-control form-control-sm select2-preselected"
                        data-allow-clear="false" id="settings_system_timezone" name="settings_system_timezone"
                        data-preselected="<?php echo e($settings->settings_system_timezone ?? ''); ?>">
                        <optgroup label="UTC">
            ...
            <div class="form-group row">
                <label class="col-12 control-label col-form-label"><?php echo e(cleanLang(__('lang.renewal_grace_period'))); ?>

                    <span class="align-middle" data-toggle="tooltip"
                        title="<?php echo e(cleanLang(__('lang.the_numer_of_days_grace_period'))); ?>" data-placement="top"><i
                            class="ti-info-alt text-themecontrast"></i></span></label>
                <div class="col-12">
                    <div class="input-group input-group-sm input-group-both">
                        <input type="number" class="form-control" id="settings_system_renewal_grace_period"
                            name="settings_system_renewal_grace_period"
                            value="<?php echo e($settings->settings_system_renewal_grace_period ?? ''); ?>">
            ...
            <div class="spacer row m-t-40">
                <div class="col-sm-12 col-lg-8">
                    <span class="title"><?php echo app('translator')->get('lang.terms_of_service'); ?></span>
                </div>
                <div class="col-sm-12 col-lg-4">
                    <div class="switch  text-right">
                        <label>
                            <input type="checkbox" name="more_information" id="more_information"
                                class="js-switch-toggle-hidden-content" data-target="toogle_terms_of_service">
            ...
            <!--more information-->
            <div class="hidden p-t-10" id="toogle_terms_of_service">
                <!--settings_terms_of_service-->
                <div class="form-group row">
                    <div class="col-lg-12">
                        <textarea class="form-control form-control-sm tinymce-textarea" rows="5"
                            name="html_settings_terms_of_service"
                            id="settings_terms_of_service"><?php echo e($settings->settings_terms_of_service ?? ''); ?></textarea>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <label
                        class="col-lg-12 text-left control-label col-form-label"><?php echo app('translator')->get('lang.terms_of_service_text'); ?></label>
                    <div class="col-lg-12">
                        <input type="text" class="form-control form-control-sm" id="settings_terms_of_service_text"
                            name="settings_terms_of_service_text"
                            value="<?php echo e($settings->settings_terms_of_service_text ?? ''); ?>">
                    </div>
                </div>

                <!--settings_terms_of_service_status-->
                <div class="form-group row">
                    <label
                        class="col-lg-12 text-left control-label col-form-label"><?php echo app('translator')->get('lang.terms_of_service_status'); ?></label>
                    <div class="col-lg-12">
                        <select class="select2-basic form-control form-control-sm select2-preselected"
                            id="settings_terms_of_service_status" name="settings_terms_of_service_status"
                            data-preselected="<?php echo e($settings->settings_terms_of_service_status ?? ''); ?>">
                            <option></option>
            ...
            <div class="text-right m-t-30">
                <button type="submit" id="commonModalSubmitButton"
                    ...
                    data-url="<?php echo e(url('app-admin/settings/general')); ?>" data-form-id="landlord-settings-form"
...
<?php echo $__env->make('landlord.settings.wrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/landlord/settings/sections/general/page.blade.php ENDPATH**/ ?>