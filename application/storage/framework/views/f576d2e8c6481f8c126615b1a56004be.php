<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('public/themes/frontend/assets/css/bootstrap.min.css')); ?>">

    <!-- Fontawesome CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('public/themes/frontend/assets/css/fontawesome.all.min.css')); ?>">

    <!-- Mobile Menu CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('public/themes/frontend/assets/plugins/meanmenu/meanmenu.min.css')); ?>">


    <!-- Main css -->
    <link rel="stylesheet" href="<?php echo e(asset('public/themes/frontend/assets/css/style.css')); ?>">

    <!-- Custom css -->
    <link rel="stylesheet" href="<?php echo e(asset('public/themes/frontend/assets/css/custom.css')); ?>">

    <!-- Vendor css -->
    <link rel="stylesheet" href="<?php echo e(asset('public/themes/frontend/assets/css/vendor.css')); ?>">

    <!-- Simple Line icons -->
    <link rel="stylesheet" href="<?php echo e(asset('public/themes/frontend/assets/fonts/simplelineicons/css/simple-line-icons.css')); ?>">


    <!-- Simple Line icons -->
    <link rel="stylesheet"
        href="<?php echo e(asset('public/themes/frontend/assets/fonts/material-design-iconic-font/material-design-icons.css')); ?>">

    <!-- jQuery JS -->
    <script src="<?php echo e(asset('public/themes/frontend/assets/js/jquery.min.js')); ?>"></script>
...
</head><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/frontend/layout/header.blade.php ENDPATH**/ ?>