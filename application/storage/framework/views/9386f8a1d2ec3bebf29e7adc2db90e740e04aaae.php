...
<div class="card" id="project_details" data-progress="<?php echo e($project->project_progress); ?>">
    ...
    <div class="card-body p-t-0 p-b-0">
        ...
        <div class="x-each-field m-b-18">
            ...
            <div class="x-content"><?php echo _clean(customFieldValue($field->customfields_name, $project,
...
<!-- Column --><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/project/components/misc/details.blade.php ENDPATH**/ ?>