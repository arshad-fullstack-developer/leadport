<div class="col-12 align-self-center hidden checkbox-actions box-shadow-minimum" id="items-checkbox-actions-container">
    ...
    <div class="x-buttons">
        ...
        <button type="button" class="btn btn-sm btn-default waves-effect waves-dark confirm-action-danger"
            data-type="form" data-ajax-type="POST" data-form-id="items-list-table" data-url="<?php echo e(url('/items/delete')); ?>"
        ...
        <button type="button"
            ...
            data-url="<?php echo e(urlResource('/items/change-category')); ?>" 
            data-action-url="<?php echo e(urlResource('/items/change-category')); ?>"
    ...
    <?php endif; ?>
</div><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/items/components/actions/checkbox-actions.blade.php ENDPATH**/ ?>