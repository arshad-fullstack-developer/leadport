<div class="table-responsive">
    ...
    <table id="demo-email-addrow" class="table m-t-0 m-b-0 table-hover no-wrap contact-list" data-page-size="10">
        ...
        <tbody id="emails-td-container">
            <!--ajax content here-->
            <?php echo $__env->make('landlord.settings.sections.emaillog.ajax', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!--ajax content here-->
        </tbody>
        <tfoot>
            <tr>
                ...
                <td colspan="20">
                    <div class="text-right">
                        <button type="button" class="btn btn-success btn-sm waves-effect text-left confirm-action-danger"
                            ...
                            data-url="<?php echo e(url('app-admin/settings/emaillog/purge')); ?>"><?php echo app('translator')->get('lang.delete_all_emails'); ?></button>
                    </div>
                </td>
            </tr>
        </tfoot>
...
<?php endif; ?><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/landlord/settings/sections/emaillog/table.blade.php ENDPATH**/ ?>