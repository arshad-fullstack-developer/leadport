...
<div class="card">
    <div class="card-body" id="landlord-settings-form">
        ...
        <div class="form-group row">
            <label class="col-12 control-label col-form-label required"><?php echo e(cleanLang(__('lang.api_key_id'))); ?></label>
            <div class="col-12">
                <input type="text" class="form-control form-control-sm" id="settings_razorpay_api_key"
                    name="settings_razorpay_api_key" value="<?php echo e($settings->settings_razorpay_api_key ?? ''); ?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-12">
                <input type="text" class="form-control form-control-sm" id="settings_razorpay_secret_key"
                    name="settings_razorpay_secret_key" value="<?php echo e($settings->settings_razorpay_secret_key ?? ''); ?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            <label class="col-12 control-label col-form-label required"><?php echo e(cleanLang(__('lang.webhooks_secret'))); ?>*
                <span class="align-middle text-themecontrast font-16" data-toggle="tooltip"
                    title="<?php echo e(cleanLang(__('lang.webhooks_secret_info'))); ?>" data-placement="top"><i
                        class="ti-info-alt"></i></span>
            </label>
            <div class="col-12">
                <input type="text" class="form-control form-control-sm" id="settings_razorpay_webhooks_secret"
                    name="settings_razorpay_webhooks_secret" value="<?php echo e($settings->settings_razorpay_webhooks_secret ?? ''); ?>">
            </div>
        </div>
        ...
        <div class="form-group row">
            <label class="col-12 control-label col-form-label required"><?php echo e(cleanLang(__('lang.webhooks_url'))); ?>*
                <span class="align-middle text-themecontrast font-16" data-toggle="tooltip"
                    title="<?php echo e(cleanLang(__('lang.webhooks_url'))); ?>" data-placement="top"><i
                        class="ti-info-alt"></i></span>
            </label>
            <div class="col-12">
                <input type="text" class="form-control form-control-sm" id="settings_stripe_ipn_url"
                    name="settings_stripe_ipn_url" value="<?php echo e(url('/app-admin/webhooks/razorpay')); ?>" disabled>
            </div>
        </div>
        ...
        <div class="text-right">
            <button type="submit" id="commonModalSubmitButton"
                ...
                data-url="<?php echo e(url('app-admin/settings/razorpay')); ?>" data-form-id="landlord-settings-form"
...
<?php echo $__env->make('landlord.settings.wrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/landlord/settings/sections/gateways/razorpay/page.blade.php ENDPATH**/ ?>