...
<div class="card">
    <div class="card-body" id="landlord-settings-form">
        ...
        <form class="form" id="settingsForm">
            ...
            <div class="form-group row">
                <label
                    class="col-sm-12 text-left control-label col-form-label required"><?php echo app('translator')->get('lang.introduction_content'); ?></label>
                <div class="col-sm-12">
            ...
            <div class="form-group row">
                <label
                    class="col-sm-12 text-left control-label col-form-label required"><?php echo app('translator')->get('lang.delivery_email_address'); ?></label>
                <div class="col-sm-12">
            ...
            <div class="form-group row">
                <label
                    class="col-sm-12 text-left control-label col-form-label required"><?php echo app('translator')->get('lang.email_subject'); ?></label>
                <div class="col-sm-12">
            ...
            <div class="form-group row">
                <label
                    class="col-sm-12 text-left control-label col-form-label required"><?php echo app('translator')->get('lang.thank_you_message'); ?></label>
                <div class="col-sm-12">
                    <textarea class="form-control form-control-sm tinymce-textarea-extended" rows="5"
                        name="html_frontend_data_5" id="html_frontend_data_2"><?php echo e($section->frontend_data_5 ?? ''); ?></textarea>
            ...
            <div class="text-right">
                <button type="submit" id="commonModalSubmitButton"
                    ...
                    data-url="<?php echo e(url('/app-admin/frontend/contact')); ?>" data-form-id="landlord-settings-form"
...
<?php echo $__env->make('landlord.frontend.wrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/landlord/frontend/contact/page.blade.php ENDPATH**/ ?>