        ...
        <div class="table-responsive list-table-wrapper">
            ...
            <table id="tickets-list-table" class="table m-t-0 m-b-0 table-hover no-wrap contact-list"
                ...
                <thead>
                    <tr>
                        ...
                        <th class="tickets_col_id"><a class="js-ajax-ux-request js-list-sorting" id="sort_ticket_id"
                                ...
                                data-url="<?php echo e(urlResource('/tickets?action=sort&orderby=ticket_id&sortorder=asc')); ?>"><?php echo e(cleanLang(__('lang.id'))); ?><span class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a>
                        </th>
                        <?php endif; ?>
                        <th class="tickets_col_subject"><a class="js-ajax-ux-request js-list-sorting"
                                id="sort_ticket_subject" href="javascript:void(0)"
                                data-url="<?php echo e(urlResource('/tickets?action=sort&orderby=ticket_subject&sortorder=asc')); ?>"><?php echo e(cleanLang(__('lang.subject'))); ?><span class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a>
                        </th>
                        ...
                        <th class="tickets_col_client"><a class="js-ajax-ux-request js-list-sorting" id="sort_client"
                                href="javascript:void(0)"
                                data-url="<?php echo e(urlResource('/tickets?action=sort&orderby=client&sortorder=asc')); ?>"><?php echo e(cleanLang(__('lang.client'))); ?><span class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a>
                        </th>
                        <?php endif; ?>
                        ...
                        <th class="tickets_col_department"><a class="js-ajax-ux-request js-list-sorting"
                                ...
                                data-url="<?php echo e(urlResource('/tickets?action=sort&orderby=category&sortorder=asc')); ?>"><?php echo e(cleanLang(__('lang.department'))); ?><span class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a>
                        </th>
                        <?php endif; ?>
                        <th class="tickets_col_date"><a class="js-ajax-ux-request js-list-sorting"
                                id="sort_ticket_created" href="javascript:void(0)"
                                data-url="<?php echo e(urlResource('/tickets?action=sort&orderby=ticket_created&sortorder=asc')); ?>"><?php echo e(cleanLang(__('lang.date'))); ?><span class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a>
                        </th>

                        <th class="tickets_col_priority"><a class="js-ajax-ux-request js-list-sorting"
                                id="sort_ticket_priority" href="javascript:void(0)"
                                data-url="<?php echo e(urlResource('/tickets?action=sort&orderby=ticket_priority&sortorder=asc')); ?>"><?php echo e(cleanLang(__('lang.priority'))); ?><span class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a>
                        </th>
                        ...
                        <th class="tickets_col_activity"><a class="js-ajax-ux-request js-list-sorting"
                                ...
                                data-url="<?php echo e(urlResource('/tickets?action=sort&orderby=ticket_last_updated&sortorder=asc')); ?>"><?php echo e(cleanLang(__('lang.activity'))); ?><span class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a>
                        </th>
                        <?php endif; ?>
                ...
                <tbody id="tickets-td-container">
                    <!--ajax content here-->
                    <?php echo $__env->make('pages.tickets.components.table.ajax', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <!--ajax content here-->
                </tbody>
                <tfoot>
                    <tr>
...
</div><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/tickets/components/table/table.blade.php ENDPATH**/ ?>