<div id="invoice-discounts-popover-content">
    <div class="p-t-10">
        ...
        <div class="form-group row">
            <label class="col-12 text-left control-label col-form-label"><?php echo app('translator')->get('lang.discount_type'); ?></label>
            <div class="col-12">
...
</div><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/bill/components/elements/discounts.blade.php ENDPATH**/ ?>