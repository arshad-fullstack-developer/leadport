    ...
    <div class="card-post" id="messaging_submit_container">
        ...
        <div id="message_meta_contaier">
            ...
            <span data-type="form" id="messages_polling_trigger" data-form-id="message_meta_contaier"
                data-ajax-type="post" data-progress-bar="hidden" data-url="<?php echo e(url('/messages/feed')); ?>">
            </span>
        </div>
    </div>
</div><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/messages/components/right-panel.blade.php ENDPATH**/ ?>