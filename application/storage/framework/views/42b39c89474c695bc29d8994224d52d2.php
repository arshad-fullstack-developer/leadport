            ...
            <div class="r-panel-body p-l-35 p-r-35">
                    ...
                    <div class="col-sm-12 col-lg-6">
                        <div class="form-group form-group-checkbox row">
                            <div class="col-12 p-t-5">
                                ...
                                <label class="p-l-30"
                                    for="standard_field[bill_date]"><?php echo app('translator')->get('lang.estimate_date'); ?></label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-checkbox row">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[bill_estimateid]"
                                    ...
                                    checked="checked">
                                <label class="p-l-30"
                                    for="standard_field[bill_estimateid]"><?php echo app('translator')->get('lang.estimate_id'); ?></label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group form-group-checkbox row">
                            <div class="col-12 p-t-5">
                                <input type="checkbox" id="standard_field[bill_final_amount]"
                                    ...
                                    checked="checked">
                                <label class="p-l-30"
                                    for="standard_field[bill_final_amount]"><?php echo app('translator')->get('lang.estimate_total'); ?></label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="buttons-block">
                    ...
                    <button type="button" class="btn btn-rounded-x btn-success js-ajax-ux-request apply-filter-button" id="export-estimates-button"
                        data-url="<?php echo e(urlResource('/export/estimates?')); ?>" data-type="form" data-ajax-type="POST"
                        data-button-loading-annimation="yes"><?php echo app('translator')->get('lang.export'); ?></button>
                </div>
            </div>
    </form>
</div>
<!--sidebar--><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/export/estimates/export.blade.php ENDPATH**/ ?>