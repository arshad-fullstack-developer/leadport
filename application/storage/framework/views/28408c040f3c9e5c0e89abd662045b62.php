<?php if(request('customfields_type') == 'tickets'): ?>
<tr class="customfields-table-settings hidden toggle-table-settings-row  toggle-table-settings-row-<?php echo e($field->customfields_id); ?>"
    ...
    <td class="b-0">
        <div class="row">
            ...
            <!--show on ticket page-->
            <div class="col-4">
                <input type="checkbox" id="customfields_show_ticket_page[<?php echo e($field->customfields_id); ?>]"
                    name="customfields_show_ticket_page[<?php echo e($field->customfields_id); ?>]"
                    class="filled-in chk-col-light-blue" <?php echo e(runtimePrechecked($field->customfields_show_ticket_page)); ?>>
                <label
                    for="customfields_show_ticket_page[<?php echo e($field->customfields_id); ?>]"><?php echo app('translator')->get('lang.show_on_ticket'); ?></label>
            </div>
...
<?php endif; ?><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/settings/sections/customfields/settings/tickets.blade.php ENDPATH**/ ?>