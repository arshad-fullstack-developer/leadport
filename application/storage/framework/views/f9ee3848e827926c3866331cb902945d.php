<div class="row" id="js-projects-modal-add-edit" data-section="<?php echo e($page['section']); ?>"
    ...
    <div class="col-lg-12">
        ...
        <div id="project-custom-fields-container">
            <?php $fields = $project_fields; $class_name_fix = ''; ?>
            <?php echo $__env->make('misc.customfields', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
        <?php endif; ?>
        ...
        <div class="form-group form-group-checkbox row">
            <label class="col-10 col-form-label text-left"><?php echo app('translator')->get('lang.automation'); ?> <span
                    ...
                    title="<?php echo app('translator')->get('lang.apply_default_automation_project'); ?>" data-placement="top"><i
        ...
        <div class="spacer row">
            <div class="col-sm-8">
                <span class="title"><?php echo e(cleanLang(__('lang.category_and_users'))); ?></span class="title">
            </div>
        ...
        <div class="hidden" id="edit_category_and_users">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-12 col-lg-9">
                    <?php if(config('system.settings_projects_permissions_basis') == 'user_roles' || config('response.mode')
                    == 'edit'): ?>
        ...
        <div id="projects_custom_fields_collaped" class="hidden">
            ...
            <div id="project-custom-fields-container">
                <?php $fields = $project_fields; $class_name_fix = 'clients_'; ?>
                <?php echo $__env->make('misc.customfields', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
            <?php endif; ?>
            <!--/#CUSTOMER FIELDS [collapsed]-->
        ...
        <?php endif; ?>
    </div><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/projects/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>