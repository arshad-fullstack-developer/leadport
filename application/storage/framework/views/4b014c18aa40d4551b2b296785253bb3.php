<div class="col-12 align-self-center hidden checkbox-actions box-shadow-minimum" id="expenses-checkbox-actions-container">
    ...
    <div class="x-buttons">
        ...
        <button type="button" class="btn btn-sm btn-default waves-effect waves-dark confirm-action-danger" 
                ...
                data-url="<?php echo e(url('/expenses/delete?type=bulk')); ?>"
        ...
        <button type="button"
            ...
            data-url="<?php echo e(urlResource('/expenses/change-category')); ?>"
            data-action-url="<?php echo e(urlResource('/expenses/change-category?type=bulk')); ?>" data-action-method="POST"
    ...
    <?php endif; ?>
</div><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/expenses/components/actions/checkbox-actions.blade.php ENDPATH**/ ?>