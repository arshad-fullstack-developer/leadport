    ...
    <div class="row signup">
        ...
        <div class="col-lg-6">
            <div class="x-splash-image">
                <img src="<?php echo e(asset('public/themes/frontend/assets/images/signup-splash.png')); ?>">
            </div>
        </div>
        <div class="col-lg-6">
...
</html><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/frontend/signup/page.blade.php ENDPATH**/ ?>