<?php if(request('customfields_type') == 'clients'): ?>
        ...
        <div class="row">
            ...
            <div class="col-4">
                <input type="checkbox" id="customfields_show_client_page[<?php echo e($field->customfields_id); ?>]"
                    ...
                    class="filled-in chk-col-light-blue" <?php echo e(runtimePrechecked($field->customfields_show_client_page)); ?>>
                <label
                    for="customfields_show_client_page[<?php echo e($field->customfields_id); ?>]"><?php echo app('translator')->get('lang.show_profile'); ?></label>
            </div>
            <!--show on invoice-->
            <div class="col-4">
                <input type="checkbox" id="customfields_show_invoice[<?php echo e($field->customfields_id); ?>]"
                    name="customfields_show_invoice[<?php echo e($field->customfields_id); ?>]" class="filled-in chk-col-light-blue"
                    <?php echo e(runtimePrechecked($field->customfields_show_invoice)); ?>>
                <label for="customfields_show_invoice[<?php echo e($field->customfields_id); ?>]"><?php echo app('translator')->get('lang.show_invoice'); ?></label>
            </div>
            <!--show in filter-->
            <div class="col-4">
...
<?php endif; ?><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/settings/sections/customfields/settings/clients.blade.php ENDPATH**/ ?>