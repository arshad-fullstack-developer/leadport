...
<div class="form-group row">
    ...
    <label
        ...
        <?php echo e($field->customfields_title); ?><?php echo e(runtimeCustomFieldsRequiredAsterix($field->customfields_required)); ?></label>
    <div class="col-sm-12">
        <textarea class="form-control form-control-sm tinymce-textarea a-custom-field" rows="5" name="<?php echo e($field->customfields_name); ?>"
    ...
    <label
        ...
        <?php echo e($field->customfields_title); ?><?php echo e(runtimeCustomFieldsRequiredAsterix($field->customfields_required)); ?></label>
    <div class="col-sm-12 col-lg-9">
        <select class="select2-basic-with-search form-control form-control-sm select2-preselected a-custom-field" id="<?php echo e($field->customfields_name); ?>"
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/misc/customfields.blade.php ENDPATH**/ ?>