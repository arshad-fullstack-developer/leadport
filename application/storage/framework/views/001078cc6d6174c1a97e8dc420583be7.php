...
<form class="form" id="settingsFormGeneral">
    ...
    <div class="form-group row">
        ...
        <div class="col-12">
            <select class="select2-basic form-control form-control-sm" id="settings_system_date_format"
                ...
                <option value="d-m-Y" <?php echo e(runtimePreselected('d-m-Y', $settings->settings_system_date_format ?? '')); ?>>
                    d-m-Y</option>
                <option value="d/m/Y" <?php echo e(runtimePreselected('d/m/Y', $settings->settings_system_date_format ?? '')); ?>>
                    d/m/Y</option>
                <option value="d.m.Y" <?php echo e(runtimePreselected('d.m.Y', $settings->settings_system_date_format ?? '')); ?>>
                    d.m.Y</option>
                <option value="m-d-Y" <?php echo e(runtimePreselected('m-d-Y', $settings->settings_system_date_format ?? '')); ?>>
                    m-d-Y</option>
                <option value="m/d/Y" <?php echo e(runtimePreselected('m/d/Y', $settings->settings_system_date_format ?? '')); ?>>
                    m/d/Y</option>
                <option value="m.d.Y" <?php echo e(runtimePreselected('m.d.Y', $settings->settings_system_date_format ?? '')); ?>>
                    m.d.Y</option>
                <option value="Y-m-d" <?php echo e(runtimePreselected('Y-m-d', $settings->settings_system_date_format ?? '')); ?>>
                    Y-m-d</option>
                <option value="Y/m/d" <?php echo e(runtimePreselected('Y/m/d', $settings->settings_system_date_format ?? '')); ?>>
                    Y/m/d</option>
                <option value="Y.m.d" <?php echo e(runtimePreselected('Y.m.d', $settings->settings_system_date_format ?? '')); ?>>
                    Y.m.d</option>
                <option value="Y-d-m" <?php echo e(runtimePreselected('Y-d-m', $settings->settings_system_date_format ?? '')); ?>>
                    Y-d-m</option>
                <option value="Y/d/m" <?php echo e(runtimePreselected('Y/d/m', $settings->settings_system_date_format ?? '')); ?>>
                    Y/d/m</option>
                <option value="Y.d.m" <?php echo e(runtimePreselected('Y.d.m', $settings->settings_system_date_format ?? '')); ?>>
    ...
    <div class="form-group row">
        ...
        <div class="col-12">
            <input type="number" class="form-control form-control-sm" id="settings_system_kanban_pagination_limits"
                ...
                value="<?php echo e($settings->settings_system_kanban_pagination_limits); ?>">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-12">
            <select class="select2-basic form-control form-control-sm" id="settings_system_close_modals_body_click"
                ...
                <option value="yes"
                    <?php echo e(runtimePreselected('yes', $settings->settings_system_close_modals_body_click ?? '')); ?>>
                    <?php echo e(cleanLang(__('lang.yes'))); ?></option>
                <option value="no"
                    <?php echo e(runtimePreselected('no', $settings->settings_system_close_modals_body_click ?? '')); ?>>
        ...
        <div class="col-12">
            <select class="select2-basic form-control form-control-sm" id="settings_system_session_login_popup"
                ...
                <option value="enabled"
                    <?php echo e(runtimePreselected('enabled', $settings->settings_system_session_login_popup ?? '')); ?>>
                    <?php echo e(cleanLang(__('lang.enabled'))); ?></option>
                <option value="disabled"
                    <?php echo e(runtimePreselected('disabled', $settings->settings_system_session_login_popup ?? '')); ?>>
    ...
    <div class="text-right">
        <button type="submit" id="commonModalSubmitButton" class="btn btn-rounded-x btn-successwaves-effect text-left"
            data-url="/settings/general" data-loading-target="" data-ajax-type="PUT" data-type="form"
            data-on-start-submit-button="disable"><?php echo e(cleanLang(__('lang.save_changes'))); ?></button>
    </div>
</form>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\leadport\application\resources\views/pages/settings/sections/general/general.blade.php ENDPATH**/ ?>